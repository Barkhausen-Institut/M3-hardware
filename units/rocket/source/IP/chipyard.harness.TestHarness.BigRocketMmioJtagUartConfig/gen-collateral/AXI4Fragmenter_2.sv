...
module AXI4Fragmenter_2(
  ...
  wire [30:0]      _deq_1_io_deq_bits_addr;	// @[Decoupled.scala:375:21]
  ...
  wire [30:0]      _deq_io_deq_bits_addr;	// @[Decoupled.scala:375:21]
  ...
  reg  [30:0]      r_addr;	// @[Fragmenter.scala:66:25]
  ...
  wire [30:0]      addr = busy ? r_addr : _deq_io_deq_bits_addr;	// @[Decoupled.scala:375:21, Fragmenter.scala:65:29, :66:25, :70:23]
  ...
  reg  [30:0]      r_addr_1;	// @[Fragmenter.scala:66:25]
  ...
  wire [30:0]      addr_1 = busy_1 ? r_addr_1 : _deq_1_io_deq_bits_addr;	// @[Decoupled.scala:375:21, Fragmenter.scala:65:29, :66:25, :70:23]
  ...
  wire [30:0]      _GEN_0 = {16'h0, _wrapMask_T_1[22:8]};	// @[Bundles.scala:33:{21,30}, Fragmenter.scala:105:29, :109:33]
  wire [30:0]      inc_addr = addr + {15'h0, 16'h1 << _deq_io_deq_bits_size};	// @[Decoupled.scala:375:21, Fragmenter.scala:70:23, :105:{29,38}]
  ...
  wire [30:0]      _GEN_1 = {16'h0, _wrapMask_T_3[22:8]};	// @[Bundles.scala:33:{21,30}, Fragmenter.scala:105:29, :109:33]
  wire [30:0]      inc_addr_1 = addr_1 + {15'h0, 16'h1 << _deq_1_io_deq_bits_size};	// @[Decoupled.scala:375:21, Fragmenter.scala:70:23, :105:{29,38}]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        r_addr = _RANDOM_0[31:1];	// @[Fragmenter.scala:65:29, :66:25]
        r_len = _RANDOM_1[7:0];	// @[Fragmenter.scala:67:25]
        busy_1 = _RANDOM_1[8];	// @[Fragmenter.scala:65:29, :67:25]
        r_addr_1 = {_RANDOM_1[31:9], _RANDOM_2[7:0]};	// @[Fragmenter.scala:66:25, :67:25]
        r_len_1 = _RANDOM_2[15:8];	// @[Fragmenter.scala:66:25, :67:25]
        wbeats_latched = _RANDOM_2[16];	// @[Fragmenter.scala:66:25, :155:35]
        w_counter = _RANDOM_2[25:17];	// @[Fragmenter.scala:66:25, :169:30]
        error_0 = _RANDOM_2[27:26];	// @[Fragmenter.scala:66:25, :197:26]
        error_1 = _RANDOM_2[29:28];	// @[Fragmenter.scala:66:25, :197:26]
        error_2 = _RANDOM_2[31:30];	// @[Fragmenter.scala:66:25, :197:26]
        error_3 = _RANDOM_3[1:0];	// @[Fragmenter.scala:197:26]
        error_4 = _RANDOM_3[3:2];	// @[Fragmenter.scala:197:26]
        error_5 = _RANDOM_3[5:4];	// @[Fragmenter.scala:197:26]
        error_6 = _RANDOM_3[7:6];	// @[Fragmenter.scala:197:26]
        error_7 = _RANDOM_3[9:8];	// @[Fragmenter.scala:197:26]
        error_8 = _RANDOM_3[11:10];	// @[Fragmenter.scala:197:26]
        error_9 = _RANDOM_3[13:12];	// @[Fragmenter.scala:197:26]
        error_10 = _RANDOM_3[15:14];	// @[Fragmenter.scala:197:26]
        error_11 = _RANDOM_3[17:16];	// @[Fragmenter.scala:197:26]
        error_12 = _RANDOM_3[19:18];	// @[Fragmenter.scala:197:26]
        error_13 = _RANDOM_3[21:20];	// @[Fragmenter.scala:197:26]
        error_14 = _RANDOM_3[23:22];	// @[Fragmenter.scala:197:26]
        error_15 = _RANDOM_3[25:24];	// @[Fragmenter.scala:197:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_147 deq (	// @[Decoupled.scala:375:21]
    .clock             (clock),
    .reset             (reset),
  ...
  Queue_147 deq_1 (	// @[Decoupled.scala:375:21]
    .clock             (clock),
    .reset             (reset),
  ...
  Queue_71_TestHarness_UNIQUIFIED in_w_deq (	// @[Decoupled.scala:375:21]
    .clock            (clock),
    .reset            (reset),
  ...
  assign auto_out_aw_bits_addr = ~(~addr_1 | {27'h0, ~(_out_bits_addr_T_9[3:0])});	// @[Fragmenter.scala:70:23, :127:{26,28,34}, package.scala:235:{46,71,76}]
  ...
  assign auto_out_ar_bits_addr = ~(~addr | {27'h0, ~(_out_bits_addr_T_2[3:0])});	// @[Fragmenter.scala:70:23, :127:{26,28,34}, package.scala:235:{46,71,76}]
