...
module AXI4Buffer(
  ...
  Queue x1_aw_deq (	// @[Decoupled.scala:375:21]
    .clock             (clock),
    .reset             (reset),
  ...
  Queue_1 x1_w_deq (	// @[Decoupled.scala:375:21]
    .clock            (clock),
    .reset            (reset),
  ...
  Queue_2 bundleIn_0_b_deq (	// @[Decoupled.scala:375:21]
    .clock            (clock),
    .reset            (reset),
  ...
  Queue x1_ar_deq (	// @[Decoupled.scala:375:21]
    .clock             (clock),
    .reset             (reset),
  ...
  Queue_4 bundleIn_0_r_deq (	// @[Decoupled.scala:375:21]
    .clock            (clock),
    .reset            (reset),
