...
module Queue_138(
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (do_enq)	// @[Decoupled.scala:280:27, :315:17, :318:{26,35}]
        enq_ptr_value <= enq_ptr_value - 1'h1;	// @[Counter.scala:61:40, :77:24]
      if (do_deq)	// @[Decoupled.scala:281:27, :315:17, :317:14]
  ...
  ram_sink_combMem_TestHarness_UNIQUIFIED ram_ext (	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits = empty ? io_enq_bits : _ram_ext_R0_data;	// @[Decoupled.scala:273:95, :278:25, :310:17, :315:17, :316:19]
endmodule
