...
module AXI4RAM_3(
  ...
  wire         w_sel0 = auto_in_aw_bits_addr[31:29] == 3'h6;	// @[Parameters.scala:137:{31,65}]
  ...
  always @(posedge clock) begin
    ...
    r_sel1 <= auto_in_ar_bits_addr[31:29] == 3'h6;	// @[Parameters.scala:137:{31,65}, SRAM.scala:73:25]
  ...
  mem_2 mem (	// @[DescribedSRAM.scala:17:26]
    .R0_addr (auto_in_ar_bits_addr[28:4]),	// @[Cat.scala:33:92]
    .R0_en   (mem_rdata_MPORT_en),	// @[Decoupled.scala:51:35]
    .R0_clk  (clock),
    .W0_addr (auto_in_aw_bits_addr[28:4]),	// @[Cat.scala:33:92]
