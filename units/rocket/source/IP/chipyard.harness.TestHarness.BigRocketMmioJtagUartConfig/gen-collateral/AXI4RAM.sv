...
module AXI4RAM(
  ...
  wire [63:0] _mem_R0_data;	// @[DescribedSRAM.scala:17:26]
  ...
  always @(posedge clock) begin
    ...
    r_sel1 <= 1'h1;	// @[SRAM.scala:73:25]
    w_sel1 <= 1'h1;	// @[SRAM.scala:74:25]
  ...
  mem mem (	// @[DescribedSRAM.scala:17:26]
    .R0_addr (auto_in_ar_bits_addr[27:3]),	// @[Cat.scala:33:92]
    .R0_en   (mem_rdata_MPORT_en),	// @[Decoupled.scala:51:35]
    .R0_clk  (clock),
    .W0_addr (auto_in_aw_bits_addr[27:3]),	// @[Cat.scala:33:92]
    .W0_en   (_T_3),	// @[Decoupled.scala:51:35]
    .W0_clk  (clock),
