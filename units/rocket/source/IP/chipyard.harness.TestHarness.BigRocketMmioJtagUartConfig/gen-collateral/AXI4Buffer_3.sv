...
module AXI4Buffer_3(
  ...
  Queue_150 x1_aw_deq (	// @[Decoupled.scala:375:21]
    .clock                      (clock),
    .reset                      (reset),
  ...
  Queue_143 x1_w_deq (	// @[Decoupled.scala:375:21]
    .clock            (clock),
    .reset            (reset),
  ...
  Queue_150 x1_ar_deq (	// @[Decoupled.scala:375:21]
    .clock                      (clock),
    .reset                      (reset),
  ...
  Queue_146 bundleIn_0_r_deq (	// @[Decoupled.scala:375:21]
    .clock                      (clock),
    .reset                      (reset),
