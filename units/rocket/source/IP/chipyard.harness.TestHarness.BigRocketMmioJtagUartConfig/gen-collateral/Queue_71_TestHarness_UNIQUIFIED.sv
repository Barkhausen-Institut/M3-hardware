...
module Queue_71_TestHarness_UNIQUIFIED(
  input          clock,
                 reset,
                 io_enq_valid,
  ...
  ram_combMem_46_TestHarness_UNIQUIFIED ram_ext (	// @[Decoupled.scala:273:95]
    .R0_addr (1'h0),
    .R0_en   (1'h1),
    .R0_clk  (clock),
    .W0_addr (1'h0),
  ...
  assign io_deq_bits_strb = maybe_full ? _ram_ext_R0_data[143:128] : io_enq_bits_strb;	// @[Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19]
  assign io_deq_bits_last = maybe_full ? _ram_ext_R0_data[144] : io_enq_bits_last;	// @[Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19]
endmodule
