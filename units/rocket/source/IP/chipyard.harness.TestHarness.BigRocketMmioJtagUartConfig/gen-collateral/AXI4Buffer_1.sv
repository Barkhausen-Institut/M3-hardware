...
module AXI4Buffer_1(
  ...
  wire _x1_w_deq_io_deq_bits_last;	// @[Decoupled.scala:375:21]
  Queue_130 x1_aw_deq (	// @[Decoupled.scala:375:21]
    .clock                      (clock),
    .reset                      (reset),
  ...
  Queue_1_TestHarness_UNIQUIFIED x1_w_deq (	// @[Decoupled.scala:375:21]
    .clock            (clock),
    .reset            (reset),
    ...
    .io_deq_bits_last (_x1_w_deq_io_deq_bits_last)
  );
  Queue_132 bundleIn_0_b_deq (	// @[Decoupled.scala:375:21]
    .clock                      (clock),
    .reset                      (reset),
  ...
  Queue_130 x1_ar_deq (	// @[Decoupled.scala:375:21]
    .clock                      (clock),
    .reset                      (reset),
  ...
  Queue_134 bundleIn_0_r_deq (	// @[Decoupled.scala:375:21]
    .clock                      (clock),
    .reset                      (reset),
