...
module FrontBus(
  ...
  TLXbar_3 subsystem_fbus_xbar (	// @[BusWrapper.scala:221:32]
  ...
  TLInterconnectCoupler_7 coupler_from_port_named_slave_port_axi4 (	// @[LazyModule.scala:489:27]
    .clock                                        (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                                        (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
  ...
  TLSerdesser serdesser (	// @[PeripheryTLSerial.scala:104:40]
    .clock                          (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                          (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
  ...
  TLInterconnectCoupler_8 coupler_from_port_named_serial_tl_ctrl (	// @[LazyModule.scala:489:27]
    .clock                         (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                         (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
  ...
  AsyncQueue out_async (	// @[PeripheryTLSerial.scala:142:29]
  ...
  AsyncQueue in_async (	// @[PeripheryTLSerial.scala:149:28]
    .io_enq_clock (1'h0),
