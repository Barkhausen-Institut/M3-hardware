...
module Queue_155(
  ...
  ram_combMem_14_TestHarness_UNIQUIFIED ram_ext (	// @[Decoupled.scala:273:95]
    .R0_addr (1'h0),
    .R0_en   (1'h1),
    .R0_clk  (clock),
    .W0_addr (1'h0),
  ...
  assign io_deq_bits_burst = maybe_full ? _ram_ext_R0_data[48:47] : io_enq_bits_burst;	// @[Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19]
  assign io_deq_bits_lock = maybe_full ? _ram_ext_R0_data[49] : io_enq_bits_lock;	// @[Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19]
  assign io_deq_bits_cache = maybe_full ? _ram_ext_R0_data[53:50] : io_enq_bits_cache;	// @[Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19]
  assign io_deq_bits_prot = maybe_full ? _ram_ext_R0_data[56:54] : io_enq_bits_prot;	// @[Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19]
  assign io_deq_bits_qos = maybe_full ? _ram_ext_R0_data[60:57] : io_enq_bits_qos;	// @[Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19]
endmodule
