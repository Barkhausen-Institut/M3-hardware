...
module Queue_130(
  ...
  wire [57:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_addr = _ram_ext_R0_data[31:4];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_echo_real_last = _ram_ext_R0_data[57];	// @[Decoupled.scala:273:95]
endmodule
