...
module Queue_142(
  ...
  ram_combMem_15_TestHarness_UNIQUIFIED ram_ext (	// @[Decoupled.scala:273:95]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_echo_real_last, io_enq_bits_qos, io_enq_bits_prot, io_enq_bits_cache, io_enq_bits_lock, io_enq_bits_burst, io_enq_bits_size, 8'h0, io_enq_bits_addr, io_enq_bits_id}),	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_addr = _ram_ext_R0_data[34:4];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_echo_real_last = _ram_ext_R0_data[60];	// @[Decoupled.scala:273:95]
endmodule
