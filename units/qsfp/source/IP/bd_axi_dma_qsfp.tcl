...
set signal_detect_0 [ create_bd_port -dir I -type intr signal_detect_0 ]
...
if { [string match [version -short] "2019.1"] } {
    ...
    set ref_clk_0 [ create_bd_port -dir I -type clk -freq_hz 50000000 ref_clk_0 ]
}
...
connect_bd_intf_net -intf_net axi_ethernet_0_mgt_clk [get_bd_intf_ports mgt_clk_0] [get_bd_intf_pins axi_ethernet_0/mgt_clk]
...
connect_bd_net -net axi_ethernet_0_signal_detect [get_bd_ports signal_detect_0] [get_bd_pins axi_ethernet_0/signal_detect]
