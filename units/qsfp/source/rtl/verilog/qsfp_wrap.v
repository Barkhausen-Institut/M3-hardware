...
(
    ...
    input  wire                                     sfp_rtl_rxn,
    input  wire                                     sfp_rtl_rxp,
...
if (ETH_INCLUDE_SHARED_LOGIC) begin: AXI_ETH
    bd_axi_dma_qsfp_wrapper i_bd_axi_dma_qsfp_wrapper (
        //AXI clock
        .aclk_0                 (clk_axi_i),
        .aresetn_0              (reset_n_i),
        ...
        .sfp_0_rxn                (sfp_rtl_rxn),
        .sfp_0_rxp                (sfp_rtl_rxp),
        .sfp_0_txn                (sfp_rtl_txn),
        .sfp_0_txp                (sfp_rtl_txp)
...
qsfp_rocket_ctrl i_qsfp_rocket_ctrl (
    .clk_i           (clk_axi_i),
