...
set AXI4_IN0 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 AXI4_IN0 ]
...
set AXI4_IN1 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 AXI4_IN1 ]
set_property -dict [ list \
    CONFIG.ADDR_WIDTH {32} \
    CONFIG.ARUSER_WIDTH {0} \
    CONFIG.AWUSER_WIDTH {0} \
...
set AXI4_OUT [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 AXI4_OUT ]
set_property -dict [ list \
    CONFIG.ADDR_WIDTH {32} \
    CONFIG.DATA_WIDTH {128} \
    CONFIG.HAS_REGION {0} \
...
connect_bd_intf_net -intf_net S00_AXI_0_1 [get_bd_intf_ports AXI4_IN0] [get_bd_intf_pins smartconnect_0/S00_AXI]
connect_bd_intf_net -intf_net S01_AXI_0_1 [get_bd_intf_ports AXI4_IN1] [get_bd_intf_pins smartconnect_0/S01_AXI]
connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_ports AXI4_OUT] [get_bd_intf_pins smartconnect_0/M00_AXI]
...
create_bd_addr_seg -range 0x000100000000 -offset 0x00000000 [get_bd_addr_spaces AXI4_IN0] [get_bd_addr_segs AXI4_OUT/Reg] SEG_AXI4_OUT0_Reg
create_bd_addr_seg -range 0x000100000000 -offset 0x00000000 [get_bd_addr_spaces AXI4_IN1] [get_bd_addr_segs AXI4_OUT/Reg] SEG_AXI4_OUT_Reg
