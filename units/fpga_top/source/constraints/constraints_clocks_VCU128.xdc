...
#create_generated_clock -name i2c_clk        [get_pins i_fpga_clk_gen_khz/mmcme4_adv_inst/CLKOUT0]
...
create_clock -period 10.000 -name sysclk1_100_p [get_ports SYSCLK1_100_P]
create_clock -period 10.000 -name sysclk2_100_n [get_ports SYSCLK2_100_N]
create_clock -period 50.000 -name TCK -waveform {0.000 25.000} [get_pins i_jtag_tunnel/BSCANE2_inst/INTERNAL_TCK]
create_clock -period 50.000 -name TCK_cfg -waveform {0.000 25.000} [get_pins i_jtag_tunnel/BSCANE2_config_inst/INTERNAL_TCK]
create_generated_clock -name eth_clk [get_pins i_fpga_clk1_gen_100/mmcme4_adv_inst/CLKOUT0]
create_generated_clock -name noc_clk [get_pins i_fpga_clk1_gen_100/mmcme4_adv_inst/CLKOUT1]
create_generated_clock -name ddr4_clk [get_pins i_fpga_clk1_gen_100/mmcme4_adv_inst/CLKOUT2]
create_generated_clock -name i2c_clk [get_pins i_fpga_clk1_gen_100/mmcme4_adv_inst/CLKOUT3]
create_generated_clock -name pm0_clk [get_pins i_fpga_clk1_gen_100/mmcme4_adv_inst/CLKOUT4]
create_generated_clock -name pm1_clk [get_pins i_fpga_clk1_gen_100/mmcme4_adv_inst/CLKOUT5]
create_generated_clock -name pm2_clk [get_pins i_fpga_clk1_gen_100/mmcme4_adv_inst/CLKOUT6]
create_generated_clock -name pm3_clk [get_pins i_fpga_clk2_gen_100/mmcme4_adv_inst/CLKOUT0]
create_generated_clock -name pm4_clk [get_pins i_fpga_clk2_gen_100/mmcme4_adv_inst/CLKOUT1]
create_generated_clock -name pm5_clk [get_pins i_fpga_clk2_gen_100/mmcme4_adv_inst/CLKOUT2]
create_generated_clock -name pm6_clk [get_pins i_fpga_clk2_gen_100/mmcme4_adv_inst/CLKOUT3]
create_generated_clock -name pm7_clk [get_pins i_fpga_clk2_gen_100/mmcme4_adv_inst/CLKOUT4]
create_generated_clock -name noc_clk_r0 -source [get_pins i_fpga_clk1_gen_100/mmcme4_adv_inst/CLKOUT1] -divide_by 1 [get_pins i_noc_domain/i_onchip_network/router_wrap_r0/clk_i]
create_generated_clock -name noc_clk_r1 -source [get_pins i_fpga_clk1_gen_100/mmcme4_adv_inst/CLKOUT1] -divide_by 1 [get_pins i_noc_domain/i_onchip_network/router_wrap_r1/clk_i]
create_generated_clock -name noc_clk_r2 -source [get_pins i_fpga_clk1_gen_100/mmcme4_adv_inst/CLKOUT1] -divide_by 1 [get_pins i_noc_domain/i_onchip_network/router_wrap_r2/clk_i]
create_generated_clock -name noc_clk_r3 -source [get_pins i_fpga_clk1_gen_100/mmcme4_adv_inst/CLKOUT1] -divide_by 1 [get_pins i_noc_domain/i_onchip_network/router_wrap_r3/clk_i]
...
set_clock_groups -name ddr4_gr -asynchronous -group [get_clocks ddr4_clk]
...
####################################################################################
# Constraints from file : 'constraints_pins_VCU128.xdc'
####################################################################################
