...
module TLInterconnectCoupler_7_boom(
  input          clock,
                 reset,
  ...
  TLBuffer_3_boom buffer (	// @[Buffer.scala:69:28]
    .clock                                     (clock),
    .reset                                     (reset),
  ...
  TLFIFOFixer_2_boom fixer (	// @[FIFOFixer.scala:146:27]
    .clock                                     (clock),
    .reset                                     (reset),
  ...
  TLWidthWidget_4_boom widget (	// @[WidthWidget.scala:220:28]
    .clock                                     (clock),
    .reset                                     (reset),
  ...
  AXI4ToTL_boom axi42tl (	// @[ToTL.scala:227:29]
    .clock                                     (clock),
    .reset                                     (reset),
  ...
  AXI4UserYanker_1_boom axi4yank (	// @[UserYanker.scala:108:30]
    .clock                          (clock),
    .reset                          (reset),
  ...
  AXI4Fragmenter_boom axi4frag (	// @[Fragmenter.scala:210:30]
    .clock                           (clock),
    .reset                           (reset),
  ...
  AXI4IdIndexer_1_boom axi4index (	// @[IdIndexer.scala:94:31]
