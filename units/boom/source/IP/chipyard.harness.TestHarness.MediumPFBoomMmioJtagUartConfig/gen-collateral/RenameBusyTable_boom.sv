...
module RenameBusyTable_boom(
  ...
  always @(posedge clock) begin
    if (reset)
      ...
      busy_table <= busy_table & ~(_busy_table_wb_T[79:0] & {80{io_wb_valids_0}} | _busy_table_wb_T_4[79:0] & {80{io_wb_valids_1}} | _busy_table_wb_T_8[79:0] & {80{io_wb_valids_2}} | _busy_table_wb_T_12[79:0] & {80{io_wb_valids_3}} | _busy_table_wb_T_16[79:0] & {80{io_wb_valids_4}}) | _busy_table_next_T[79:0] & {80{io_rebusy_reqs_0}} | _busy_table_next_T_4[79:0] & {80{io_rebusy_reqs_1}};	// @[Bitwise.scala:77:12, OneHot.scala:57:35, rename-busytable.scala:48:27, :50:{34,36}, :51:{48,88}, :53:39, :54:49]
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_1 = `RANDOM;
        _RANDOM_2 = `RANDOM;
        busy_table = {_RANDOM_0, _RANDOM_1, _RANDOM_2[15:0]};	// @[rename-busytable.scala:48:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
