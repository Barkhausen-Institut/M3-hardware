...
module Queue_104_boom(
  ...
  ram_combMem_17_boom ram_ext (	// @[Decoupled.scala:273:95]
    .R0_addr (1'h0),
    .R0_en   (1'h1),
    .R0_clk  (clock),
    .W0_addr (1'h0),
  ...
  assign io_deq_bits_echo_tl_state_size = _ram_ext_R0_data[64:61];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_echo_tl_state_source = _ram_ext_R0_data[68:65];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_wen = _ram_ext_R0_data[69];	// @[Decoupled.scala:273:95]
endmodule
