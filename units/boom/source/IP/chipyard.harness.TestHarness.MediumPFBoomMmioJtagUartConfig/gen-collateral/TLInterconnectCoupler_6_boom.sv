...
module TLInterconnectCoupler_6_boom(
  input         clock,
                reset,
  ...
  input  [26:0] auto_tl_in_a_bits_address,
  ...
  output [26:0] auto_control_xing_out_a_bits_address,
  ...
  TLFragmenter_1_boom fragmenter (	// @[Fragmenter.scala:335:34]
    .clock                   (clock),
    .reset                   (reset),
