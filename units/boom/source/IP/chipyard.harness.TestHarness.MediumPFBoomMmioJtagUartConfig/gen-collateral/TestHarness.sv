...
module TestHarness(
  ...
  wire [63:0]  _chiptop0_trace_traces_0_trace_insns_0_wdata;	// @[HasHarnessInstantiators.scala:82:40]
  wire         _chiptop0_trace_traces_0_trace_insns_1_valid;	// @[HasHarnessInstantiators.scala:82:40]
  wire [39:0]  _chiptop0_trace_traces_0_trace_insns_1_iaddr;	// @[HasHarnessInstantiators.scala:82:40]
  wire [31:0]  _chiptop0_trace_traces_0_trace_insns_1_insn;	// @[HasHarnessInstantiators.scala:82:40]
  wire [2:0]   _chiptop0_trace_traces_0_trace_insns_1_priv;	// @[HasHarnessInstantiators.scala:82:40]
  wire         _chiptop0_trace_traces_0_trace_insns_1_exception;	// @[HasHarnessInstantiators.scala:82:40]
  wire         _chiptop0_trace_traces_0_trace_insns_1_interrupt;	// @[HasHarnessInstantiators.scala:82:40]
  wire [63:0]  _chiptop0_trace_traces_0_trace_insns_1_cause;	// @[HasHarnessInstantiators.scala:82:40]
  wire [39:0]  _chiptop0_trace_traces_0_trace_insns_1_tval;	// @[HasHarnessInstantiators.scala:82:40]
  wire [63:0]  _chiptop0_trace_traces_0_trace_insns_1_wdata;	// @[HasHarnessInstantiators.scala:82:40]
  wire [63:0]  _chiptop0_trace_traces_0_trace_time;	// @[HasHarnessInstantiators.scala:82:40]
  wire         _chiptop0_trace_traces_0_trace_custom_rob_empty;	// @[HasHarnessInstantiators.scala:82:40]
  ...
  ChipTop chiptop0 (	// @[HasHarnessInstantiators.scala:82:40]
    ...
    .trace_traces_0_trace_insns_0_wdata     (_chiptop0_trace_traces_0_trace_insns_0_wdata),
    .trace_traces_0_trace_insns_1_valid     (_chiptop0_trace_traces_0_trace_insns_1_valid),
    .trace_traces_0_trace_insns_1_iaddr     (_chiptop0_trace_traces_0_trace_insns_1_iaddr),
    .trace_traces_0_trace_insns_1_insn      (_chiptop0_trace_traces_0_trace_insns_1_insn),
    .trace_traces_0_trace_insns_1_priv      (_chiptop0_trace_traces_0_trace_insns_1_priv),
    .trace_traces_0_trace_insns_1_exception (_chiptop0_trace_traces_0_trace_insns_1_exception),
    .trace_traces_0_trace_insns_1_interrupt (_chiptop0_trace_traces_0_trace_insns_1_interrupt),
    .trace_traces_0_trace_insns_1_cause     (_chiptop0_trace_traces_0_trace_insns_1_cause),
    .trace_traces_0_trace_insns_1_tval      (_chiptop0_trace_traces_0_trace_insns_1_tval),
    .trace_traces_0_trace_insns_1_wdata     (_chiptop0_trace_traces_0_trace_insns_1_wdata),
    .trace_traces_0_trace_time              (_chiptop0_trace_traces_0_trace_time),
    .trace_traces_0_trace_custom_rob_empty  (_chiptop0_trace_traces_0_trace_custom_rob_empty)
  );
  SimJTAG #(
    .TICK_DELAY(3)
