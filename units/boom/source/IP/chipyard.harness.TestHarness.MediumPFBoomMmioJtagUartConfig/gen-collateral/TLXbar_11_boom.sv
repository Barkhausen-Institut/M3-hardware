...
module TLXbar_11_boom(
  ...
  assign auto_in_d_bits_source = (muxStateEarly_0 ? auto_out_0_d_bits_source : 11'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_source : 11'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
