...
module TLInterconnectCoupler_19_boom(
  input          clock,
                 reset,
  ...
  AXI4UserYanker_2_boom axi4yank (	// @[UserYanker.scala:108:30]
    .clock                                (clock),
    .reset                                (reset),
  ...
  AXI4IdIndexer_2_boom axi4index (	// @[IdIndexer.scala:94:31]
  ...
  TLToAXI4_1_boom tl2axi4 (	// @[ToAXI4.scala:286:29]
    .clock                                 (clock),
    .reset                                 (reset),
  ...
  TLWidthWidget_8_boom widget (	// @[WidthWidget.scala:220:28]
    .clock                   (clock),
    .reset                   (reset),
