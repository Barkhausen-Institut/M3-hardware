...
module AXI4Fragmenter_3(
  ...
  wire [31:0]      _GEN_0 = {17'h0, _wrapMask_T_1[22:8]};	// @[Bundles.scala:33:{21,30}, Fragmenter.scala:105:29, :109:33]
  wire [31:0]      inc_addr = addr + {16'h0, 16'h1 << _deq_io_deq_bits_size};	// @[Decoupled.scala:375:21, Fragmenter.scala:70:23, :105:{29,38}]
  ...
  wire [31:0]      _GEN_1 = {17'h0, _wrapMask_T_3[22:8]};	// @[Bundles.scala:33:{21,30}, Fragmenter.scala:105:29, :109:33]
  wire [31:0]      inc_addr_1 = addr_1 + {16'h0, 16'h1 << _deq_1_io_deq_bits_size};	// @[Decoupled.scala:375:21, Fragmenter.scala:70:23, :105:{29,38}]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        error_2 = _RANDOM_3[1:0];	// @[Fragmenter.scala:197:26]
        error_3 = _RANDOM_3[3:2];	// @[Fragmenter.scala:197:26]
        error_4 = _RANDOM_3[5:4];	// @[Fragmenter.scala:197:26]
        error_5 = _RANDOM_3[7:6];	// @[Fragmenter.scala:197:26]
        error_6 = _RANDOM_3[9:8];	// @[Fragmenter.scala:197:26]
        error_7 = _RANDOM_3[11:10];	// @[Fragmenter.scala:197:26]
        error_8 = _RANDOM_3[13:12];	// @[Fragmenter.scala:197:26]
        error_9 = _RANDOM_3[15:14];	// @[Fragmenter.scala:197:26]
        error_10 = _RANDOM_3[17:16];	// @[Fragmenter.scala:197:26]
        error_11 = _RANDOM_3[19:18];	// @[Fragmenter.scala:197:26]
        error_12 = _RANDOM_3[21:20];	// @[Fragmenter.scala:197:26]
        error_13 = _RANDOM_3[23:22];	// @[Fragmenter.scala:197:26]
        error_14 = _RANDOM_3[25:24];	// @[Fragmenter.scala:197:26]
        error_15 = _RANDOM_3[27:26];	// @[Fragmenter.scala:197:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_159 deq (	// @[Decoupled.scala:375:21]
    .clock             (clock),
    .reset             (reset),
  ...
  Queue_159 deq_1 (	// @[Decoupled.scala:375:21]
    .clock             (clock),
    .reset             (reset),
