...
module data_combMem_boom(	// @[ListBuffer.scala:51:18]
  input  [5:0]  R0_addr,
  input         R0_en,
                R0_clk,
  input  [5:0]  W0_addr,
  ...
  reg [46:0] Memory[0:32];	// @[ListBuffer.scala:51:18]
  ...
  `ifndef SYNTHESIS	// @[ListBuffer.scala:51:18]
    ...
    initial begin	// @[ListBuffer.scala:51:18]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[ListBuffer.scala:51:18]
        for (initvar = 0; initvar < 33; initvar = initvar + 1) begin
  ...
  assign R0_data = R0_en ? Memory[R0_addr] : 47'bx;	// @[ListBuffer.scala:51:18]
endmodule
