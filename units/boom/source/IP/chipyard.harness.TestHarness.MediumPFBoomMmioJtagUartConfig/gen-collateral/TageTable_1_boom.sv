...
module TageTable_1_boom(
  ...
  wire [6:0]  _s2_req_rlous_T_1 = io_f1_req_pc[9:3] ^ _GEN;	// @[frontend.scala:163:35, tage.scala:60:29]
  ...
  wire [6:0]  update_idx = io_update_pc[9:3] ^ _GEN_0;	// @[frontend.scala:163:35, tage.scala:60:29]
  wire [6:0]  update_wdata_3_tag = io_update_pc[16:10] ^ _GEN_0;	// @[frontend.scala:163:35, tage.scala:60:29, :62:{30,50}]
  ...
  always @(posedge clock) begin
    ...
    s2_tag <= io_f1_req_pc[16:10] ^ _GEN;	// @[frontend.scala:163:35, tage.scala:60:29, :62:{30,50}, :95:29]
  ...
  hi_us_0_boom hi_us (	// @[tage.scala:89:27]
  ...
  lo_us_0_boom lo_us (	// @[tage.scala:90:27]
    .R0_addr (_s2_req_rlous_T_1),	// @[tage.scala:60:29]
    .R0_en   (io_f1_req_valid),
    .R0_clk  (clock),
  ...
  table_0_0_boom table_0 (	// @[tage.scala:91:27]
    .R0_addr (_s2_req_rlous_T_1),	// @[tage.scala:60:29]
    .R0_en   (io_f1_req_valid),
    .R0_clk  (clock),
