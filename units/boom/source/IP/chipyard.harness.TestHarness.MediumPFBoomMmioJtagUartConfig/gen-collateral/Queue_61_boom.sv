...
module Queue_61_boom(
  ...
  wire [125:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_combMem_42_boom ram_ext (	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_user_amba_prot_bufferable = _ram_ext_R0_data[46];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_user_amba_prot_modifiable = _ram_ext_R0_data[47];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_user_amba_prot_readalloc = _ram_ext_R0_data[48];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_user_amba_prot_writealloc = _ram_ext_R0_data[49];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_user_amba_prot_privileged = _ram_ext_R0_data[50];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_user_amba_prot_secure = _ram_ext_R0_data[51];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_user_amba_prot_fetch = _ram_ext_R0_data[52];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[60:53];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[124:61];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[125];	// @[Decoupled.scala:273:95]
endmodule
