...
module MulDiv_boom(
  ...
  wire [65:0]  _GEN = {{65{remainder[64]}}, remainder[0]} * {divisor[64], divisor} + {remainder[129], remainder[129:65]};	// @[Multiplier.scala:57:20, :58:22, :104:31, :105:31, :106:24, :109:{38,67,76}]
  wire [64:0]  subtractor = remainder[128:64] - divisor;	// @[Multiplier.scala:57:20, :58:22, :85:{29,37}]
  wire         _eOut_T_9 = count == 7'h0;	// @[Multiplier.scala:51:18, :120:20, :143:24]
  ...
  always @(posedge clock) begin
    ...
    if (_T_23) begin	// @[Decoupled.scala:51:35]
      ...
      if (_T_17) begin	// @[Multiplier.scala:126:39]
        if (_eOut_T_9 & ~divby0 & _eOutPos_T_1 != 6'h3F) begin	// @[Multiplier.scala:114:45, :143:{24,32}, :149:35, :150:{35,43,54}]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        count = _RANDOM_4[19:13];	// @[Multiplier.scala:51:18]
        neg_out = _RANDOM_4[20];	// @[Multiplier.scala:51:18, :54:20]
        isHi = _RANDOM_4[21];	// @[Multiplier.scala:51:18, :55:17]
        resHi = _RANDOM_4[22];	// @[Multiplier.scala:51:18, :56:18]
        divisor = {_RANDOM_4[31:23], _RANDOM_5, _RANDOM_6[23:0]};	// @[Multiplier.scala:51:18, :57:20]
