...
module ram_data_combMem_boom(	// @[Decoupled.scala:273:95]
  input  [1:0]  R0_addr,
  input         R0_en,
                R0_clk,
  input  [1:0]  W0_addr,
  ...
  reg [63:0] Memory[0:2];	// @[Decoupled.scala:273:95]
  ...
  assign R0_data = R0_en ? Memory[R0_addr] : 64'bx;	// @[Decoupled.scala:273:95]
endmodule
