...
module AXI4IdIndexer_1_boom(
  ...
  assign auto_out_aw_bits_id = auto_in_aw_bits_id[0];	// @[BundleMap.scala:247:19]
  ...
  assign auto_out_aw_bits_echo_extra_id = auto_in_aw_bits_id[3:1];	// @[IdIndexer.scala:74:56]
  ...
  assign auto_out_ar_bits_id = auto_in_ar_bits_id[0];	// @[BundleMap.scala:247:19]
  ...
  assign auto_out_ar_bits_echo_extra_id = auto_in_ar_bits_id[3:1];	// @[IdIndexer.scala:73:56]
