...
module Queue_103_boom(
  ...
  assign io_deq_bits_strb = _ram_ext_R0_data[143:128];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_last = _ram_ext_R0_data[144];	// @[Decoupled.scala:273:95]
endmodule
