...
module TLXbar_5_boom(
  ...
  output [26:0] auto_out_2_a_bits_address,
  ...
  wire        requestAIO_0_0 = {auto_in_a_bits_address[27:25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13] ^ 2'h1} == 7'h0;	// @[Bundles.scala:259:74, Parameters.scala:137:{31,45,65}]
  wire [11:0] _GEN = auto_in_a_bits_address[27:16] ^ 12'h201;	// @[Parameters.scala:137:31]
  wire        requestAIO_0_1 = {_GEN[11:9], auto_in_a_bits_address[20], _GEN[0], auto_in_a_bits_address[14:13]} == 7'h0;	// @[Bundles.scala:259:74, Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_2 = {auto_in_a_bits_address[27:25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13] ^ 2'h2} == 7'h0 | {auto_in_a_bits_address[27:25] ^ 3'h2, auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13]} == 7'h0;	// @[Bundles.scala:259:74, Parameters.scala:137:{31,45,65}, Xbar.scala:366:92]
  wire        requestAIO_0_4 = {auto_in_a_bits_address[27:25] ^ 3'h1, auto_in_a_bits_address[20], auto_in_a_bits_address[16]} == 5'h0;	// @[Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_5 = {auto_in_a_bits_address[27:25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13]} == 7'h0;	// @[Bundles.scala:259:74, Parameters.scala:137:{45,65}]
  wire        requestAIO_0_6 = {auto_in_a_bits_address[27:25], auto_in_a_bits_address[20], ~(auto_in_a_bits_address[16])} == 5'h0;	// @[Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_7 = {auto_in_a_bits_address[27:25], ~(auto_in_a_bits_address[20]), auto_in_a_bits_address[14:13]} == 6'h0;	// @[Arbiter.scala:113:44, Parameters.scala:137:{31,45,65}]
  ...
  assign auto_in_a_ready = requestAIO_0_0 & auto_out_0_a_ready | requestAIO_0_1 & auto_out_1_a_ready | requestAIO_0_2 & auto_out_2_a_ready | (&(auto_in_a_bits_address[27:26])) & auto_out_3_a_ready | requestAIO_0_4 & auto_out_4_a_ready | requestAIO_0_5 & auto_out_5_a_ready | requestAIO_0_6 & auto_out_6_a_ready | requestAIO_0_7 & auto_out_7_a_ready;	// @[Mux.scala:27:73, Parameters.scala:137:65, Xbar.scala:366:92]
  assign auto_in_d_valid = out_27_valid;	// @[Arbiter.scala:126:29]
  assign auto_in_d_bits_opcode = (muxStateEarly_0 ? auto_out_0_d_bits_opcode : 3'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_opcode : 3'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_opcode : 3'h0) | (muxStateEarly_3 ? auto_out_3_d_bits_opcode : 3'h0) | (muxStateEarly_4 ? auto_out_4_d_bits_opcode : 3'h0) | (muxStateEarly_5 ? auto_out_5_d_bits_opcode : 3'h0) | {2'h0, muxStateEarly_6} | (muxStateEarly_7 ? auto_out_7_d_bits_opcode : 3'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_in_d_bits_param = (muxStateEarly_0 ? auto_out_0_d_bits_param : 2'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_param : 2'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_param : 2'h0) | (muxStateEarly_4 ? auto_out_4_d_bits_param : 2'h0) | (muxStateEarly_7 ? auto_out_7_d_bits_param : 2'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  assign auto_in_d_bits_size = (muxStateEarly_0 ? auto_out_0_d_bits_size : 4'h0) | (muxStateEarly_1 ? {1'h0, auto_out_1_d_bits_size} : 4'h0) | (muxStateEarly_2 ? {1'h0, auto_out_2_d_bits_size} : 4'h0) | (muxStateEarly_3 ? {1'h0, auto_out_3_d_bits_size} : 4'h0) | (muxStateEarly_4 ? {1'h0, auto_out_4_d_bits_size} : 4'h0) | (muxStateEarly_5 ? {1'h0, auto_out_5_d_bits_size} : 4'h0) | (muxStateEarly_6 ? {1'h0, auto_out_6_d_bits_size} : 4'h0) | (muxStateEarly_7 ? {1'h0, auto_out_7_d_bits_size} : 4'h0);	// @[Arbiter.scala:118:30, BundleMap.scala:247:19, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_in_d_bits_source = (muxStateEarly_0 ? auto_out_0_d_bits_source : 7'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_source : 7'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_source : 7'h0) | (muxStateEarly_3 ? auto_out_3_d_bits_source : 7'h0) | (muxStateEarly_4 ? auto_out_4_d_bits_source : 7'h0) | (muxStateEarly_5 ? auto_out_5_d_bits_source : 7'h0) | (muxStateEarly_6 ? auto_out_6_d_bits_source : 7'h0) | (muxStateEarly_7 ? auto_out_7_d_bits_source : 7'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_in_d_bits_sink = muxStateEarly_0 & auto_out_0_d_bits_sink | muxStateEarly_1 & auto_out_1_d_bits_sink | muxStateEarly_2 & auto_out_2_d_bits_sink | muxStateEarly_4 & auto_out_4_d_bits_sink | muxStateEarly_7 & auto_out_7_d_bits_sink;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  assign auto_in_d_bits_denied = muxStateEarly_0 & auto_out_0_d_bits_denied | muxStateEarly_1 & auto_out_1_d_bits_denied | muxStateEarly_2 & auto_out_2_d_bits_denied | muxStateEarly_4 & auto_out_4_d_bits_denied | muxStateEarly_7 & auto_out_7_d_bits_denied;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  ...
  assign auto_in_d_bits_corrupt = muxStateEarly_0 & auto_out_0_d_bits_corrupt | muxStateEarly_1 & auto_out_1_d_bits_corrupt | muxStateEarly_2 & auto_out_2_d_bits_corrupt | muxStateEarly_4 & auto_out_4_d_bits_corrupt | muxStateEarly_7 & auto_out_7_d_bits_corrupt;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  ...
  assign auto_out_3_a_valid = auto_in_a_valid & (&(auto_in_a_bits_address[27:26]));	// @[Parameters.scala:137:65, Xbar.scala:431:50]
  ...
  assign auto_out_2_a_bits_address = auto_in_a_bits_address[26:0];	// @[BundleMap.scala:247:19]
