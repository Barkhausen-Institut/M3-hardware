...
module SystemBus_boom(
  ...
  wire [2:0]  _fixer_auto_out_1_c_bits_source;	// @[FIFOFixer.scala:146:27]
  ...
  FixedClockBroadcast_boom fixedClockNode (	// @[ClockGroup.scala:110:107]
  ...
  TLXbar_boom system_bus_xbar (	// @[SystemBus.scala:40:43]
  ...
  TLFIFOFixer_boom fixer (	// @[FIFOFixer.scala:146:27]
    .clock                                       (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                                       (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
    ...
    .auto_out_1_b_bits_source                    (3'h0),	// @[SystemBus.scala:40:43]
  ...
  TLInterconnectCoupler_4_boom coupler_to_port_named_mmio_port_axi4 (	// @[LazyModule.scala:489:27]
    .clock                                       (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                                       (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
