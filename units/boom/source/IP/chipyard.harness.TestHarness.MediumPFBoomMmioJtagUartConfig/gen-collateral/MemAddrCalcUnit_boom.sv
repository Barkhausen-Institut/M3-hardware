...
module MemAddrCalcUnit_boom(
  ...
  assign io_resp_valid = io_req_valid & (io_brupdate_b1_mispredict_mask & io_req_bits_uop_br_mask) == 12'h0;	// @[functional-unit.scala:266:38, util.scala:118:{51,59}]
