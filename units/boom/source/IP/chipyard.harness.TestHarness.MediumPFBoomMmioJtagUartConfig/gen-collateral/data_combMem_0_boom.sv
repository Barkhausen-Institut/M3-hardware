...
module data_combMem_0_boom(	// @[ListBuffer.scala:51:18]
  input  [3:0]  R0_addr,
  input         R0_en,
                R0_clk,
  input  [3:0]  W0_addr,
  ...
  reg [64:0] Memory[0:15];	// @[ListBuffer.scala:51:18]
  ...
  assign R0_data = R0_en ? Memory[R0_addr] : 65'bx;	// @[ListBuffer.scala:51:18]
endmodule
