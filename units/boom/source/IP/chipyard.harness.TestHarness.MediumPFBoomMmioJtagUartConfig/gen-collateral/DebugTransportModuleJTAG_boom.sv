...
module DebugTransportModuleJTAG_boom(
  input         io_jtag_clock,
                io_jtag_reset,
                io_dmi_req_ready,
                io_dmi_resp_valid,
  ...
  CaptureUpdateChain_boom dtmInfoChain (	// @[DebugTransport.scala:128:29]
    .clock                     (io_jtag_clock),
    .reset                     (io_jtag_reset),
  ...
  CaptureUpdateChain_1_boom dmiAccessChain (	// @[DebugTransport.scala:134:31]
    .clock                (io_jtag_clock),
    .reset                (io_jtag_reset),
  ...
  CaptureChain_boom tapIO_idcodeChain (	// @[JtagTap.scala:181:33]
    .clock              (io_jtag_clock),
    .reset              (io_jtag_reset),
  ...
  JtagTapController_boom tapIO_controllerInternal (	// @[JtagTap.scala:199:36]
    .clock                           (io_jtag_clock),
    .reset                           (io_jtag_reset),
  ...
  JtagBypassChain_boom tapIO_bypassChain (	// @[JtagTap.scala:207:29]
    .clock              (io_jtag_clock),
    .reset              (io_jtag_reset),
