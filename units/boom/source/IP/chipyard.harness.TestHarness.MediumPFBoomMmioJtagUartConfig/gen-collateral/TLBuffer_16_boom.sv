...
module TLBuffer_16_boom(
  ...
  Queue_124_boom x1_a_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_125_boom bundleIn_0_d_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_126_boom bundleIn_0_b_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_127_boom x1_c_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_109_boom x1_e_q (	// @[Decoupled.scala:375:21]
    .clock            (clock),
    .reset            (reset),
