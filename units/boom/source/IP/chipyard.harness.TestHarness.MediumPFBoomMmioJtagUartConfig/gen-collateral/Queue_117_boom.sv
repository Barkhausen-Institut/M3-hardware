...
module Queue_117_boom(
  ...
  ram_combMem_26_boom ram_ext (	// @[Decoupled.scala:273:95]
    .R0_addr (1'h0),
    .R0_en   (1'h1),
    .R0_clk  (clock),
    .W0_addr (1'h0),
  ...
  assign io_deq_bits_sink = maybe_full ? _ram_ext_R0_data[16:14] : io_enq_bits_sink;	// @[Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19]
  assign io_deq_bits_denied = maybe_full ? _ram_ext_R0_data[17] : io_enq_bits_denied;	// @[Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19]
  assign io_deq_bits_data = maybe_full ? _ram_ext_R0_data[81:18] : io_enq_bits_data;	// @[Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19]
