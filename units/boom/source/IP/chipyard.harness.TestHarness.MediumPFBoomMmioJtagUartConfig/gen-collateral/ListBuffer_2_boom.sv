...
module ListBuffer_2_boom(
  ...
  input  [15:0] io_push_bits_data_tag,
  ...
  output [15:0] io_data_tag,
  output [5:0]  io_data_offset,
                io_data_put
);

  wire [46:0] _data_ext_R0_data;	// @[ListBuffer.scala:51:18]
  ...
  head_combMem_0_boom head_ext (	// @[ListBuffer.scala:47:18]
    .R0_addr (io_pop_bits),
    .R0_en   (1'h1),
    .R0_clk  (clock),
  ...
  tail_combMem_0_boom tail_ext (	// @[ListBuffer.scala:48:18]
    .R0_addr (io_pop_bits),
    .R0_en   (io_pop_valid),
    .R0_clk  (clock),
  ...
  next_combMem_0_boom next_ext (	// @[ListBuffer.scala:50:18]
  ...
  data_combMem_boom data_ext (	// @[ListBuffer.scala:51:18]
    .R0_addr (_head_ext_R0_data),	// @[ListBuffer.scala:47:18]
    .R0_en   (1'h1),
    .R0_clk  (clock),
  ...
  assign io_data_tag = _data_ext_R0_data[34:19];	// @[ListBuffer.scala:51:18]
  assign io_data_offset = _data_ext_R0_data[40:35];	// @[ListBuffer.scala:51:18]
  assign io_data_put = _data_ext_R0_data[46:41];	// @[ListBuffer.scala:51:18]
endmodule
