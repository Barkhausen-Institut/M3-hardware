...
module Queue_121_boom(
  ...
  wire [336:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_combMem_50_boom ram_ext (	// @[Decoupled.scala:273:95]
    .R0_addr (1'h0),
    .R0_en   (1'h1),
    .R0_clk  (clock),
    .W0_addr (1'h0),
  ...
  assign io_deq_bits_meta_0 = maybe_full ? _ram_ext_R0_data[335:216] : io_enq_bits_meta_0;	// @[Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19]
  assign io_deq_bits_lhist_0 = maybe_full & _ram_ext_R0_data[336];	// @[Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19]
endmodule
