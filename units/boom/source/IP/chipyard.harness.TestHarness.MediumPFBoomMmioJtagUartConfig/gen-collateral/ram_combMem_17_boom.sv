...
module ram_combMem_17_boom(	// @[Decoupled.scala:273:95]
  input         R0_addr,
                R0_en,
                R0_clk,
                W0_addr,
  ...
  reg [69:0] Memory[0:0];	// @[Decoupled.scala:273:95]
    ...
    initial begin	// @[Decoupled.scala:273:95]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[Decoupled.scala:273:95]
        for (initvar = 0; initvar < 1; initvar = initvar + 1) begin
          ...
          Memory[initvar] = _RANDOM_MEM[69:0];
        end	// @[Decoupled.scala:273:95]
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // not def SYNTHESIS
  assign R0_data = R0_en ? Memory[R0_addr] : 70'bx;	// @[Decoupled.scala:273:95]
endmodule
