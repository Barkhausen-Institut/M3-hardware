...
module TLInterconnectCoupler_17_boom(
  input         clock,
                reset,
  ...
  TLFIFOFixer_4_boom fixer (	// @[FIFOFixer.scala:146:27]
    .clock                   (clock),
    .reset                   (reset),
  ...
  TLFragmenter_7_boom fragmenter (	// @[Fragmenter.scala:335:34]
    .clock                   (clock),
    .reset                   (reset),
  ...
  TLBuffer_9_boom buffer (	// @[Buffer.scala:69:28]
    .clock                   (clock),
    .reset                   (reset),
