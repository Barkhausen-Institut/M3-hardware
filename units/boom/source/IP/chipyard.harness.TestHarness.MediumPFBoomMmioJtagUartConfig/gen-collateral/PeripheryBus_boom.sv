...
module PeripheryBus_boom(
  ...
  input  [26:0] auto_bus_xing_in_a_bits_address,
  ...
  output [26:0] auto_coupler_to_device_named_uart_0_control_xing_out_a_bits_address,
  ...
  wire [26:0] _buffer_1_auto_out_a_bits_address;	// @[Buffer.scala:69:28]
  ...
  wire [26:0] _atomics_auto_out_a_bits_address;	// @[AtomicAutomata.scala:285:29]
  ...
  wire [26:0] _buffer_auto_out_a_bits_address;	// @[Buffer.scala:69:28]
  ...
  wire [26:0] _out_xbar_auto_out_1_a_bits_address;	// @[PeripheryBus.scala:50:30]
  ...
  wire [26:0] _fixer_auto_out_a_bits_address;	// @[PeripheryBus.scala:47:33]
  ...
  always @(posedge _fixedClockNode_auto_out_0_clock) begin	// @[ClockGroup.scala:110:107]
    if (_fixedClockNode_auto_out_0_reset)	// @[ClockGroup.scala:110:107]
      bootAddrReg <= 64'h10000000;	// @[BootAddrReg.scala:32:34]
  ...
  TLFIFOFixer_1_boom fixer (	// @[PeripheryBus.scala:47:33]
  ...
  TLXbar_2_boom out_xbar (	// @[PeripheryBus.scala:50:30]
    .clock                     (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                     (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
  ...
  TLBuffer_boom buffer (	// @[Buffer.scala:69:28]
    .clock                   (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                   (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
  ...
  TLAtomicAutomata_boom atomics (	// @[AtomicAutomata.scala:285:29]
    .clock                   (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                   (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
  ...
  TLBuffer_boom buffer_1 (	// @[Buffer.scala:69:28]
    .clock                   (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                   (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
  ...
  TLInterconnectCoupler_5_boom coupler_to_bootaddressreg (	// @[LazyModule.scala:489:27]
    .clock                              (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                              (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
  ...
  TLInterconnectCoupler_6_boom coupler_to_device_named_uart_0 (	// @[LazyModule.scala:489:27]
    .clock                                (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                                (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
