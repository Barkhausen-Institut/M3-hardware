...
module AsyncQueueSink_3_boom(
  ...
  AsyncResetSynchronizerShiftReg_w1_d3_i0_boom widx_widx_gray (	// @[ShiftReg.scala:45:23]
    .clock (clock),
    .reset (reset),
    .io_d  (io_async_widx),
    .io_q  (_widx_widx_gray_io_q)
  );
  ClockCrossingReg_w55_boom io_deq_bits_deq_bits_reg (	// @[SynchronizerReg.scala:207:25]
    .clock (clock),
  ...
  AsyncValidSync_boom sink_valid_0 (	// @[AsyncQueue.scala:168:33]
  ...
  AsyncValidSync_boom sink_valid_1 (	// @[AsyncQueue.scala:169:33]
  ...
  AsyncValidSync_boom source_extend (	// @[AsyncQueue.scala:171:31]
  ...
  AsyncValidSync_boom source_valid (	// @[AsyncQueue.scala:172:31]
