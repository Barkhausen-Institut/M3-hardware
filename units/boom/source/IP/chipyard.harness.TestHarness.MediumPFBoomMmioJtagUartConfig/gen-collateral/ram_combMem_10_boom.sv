...
module ram_combMem_10_boom(	// @[Decoupled.scala:273:95]
  input         R0_addr,
                R0_en,
                R0_clk,
                W0_addr,
  ...
  reg [32:0] Memory[0:0];	// @[Decoupled.scala:273:95]
  ...
  assign R0_data = R0_en ? Memory[R0_addr] : 33'bx;	// @[Decoupled.scala:273:95]
endmodule
