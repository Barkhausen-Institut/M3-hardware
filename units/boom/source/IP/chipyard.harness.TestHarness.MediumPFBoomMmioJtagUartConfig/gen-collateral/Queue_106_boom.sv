...
module Queue_106_boom(
  ...
  wire [116:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_combMem_37_boom ram_ext (	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_mask = _ram_ext_R0_data[51:44];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[115:52];	// @[Decoupled.scala:273:95]
endmodule
