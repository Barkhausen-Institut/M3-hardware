...
module Queue_37_boom(
  ...
  input         io_enq_bits_echo_extra_id,
                io_enq_bits_last,
                io_deq_ready,
  output        io_enq_ready,
  ...
  output        io_deq_bits_echo_extra_id,
                io_deq_bits_last
);
  ...
  wire        do_deq = io_deq_ready & ~(ptr_match & ~maybe_full);	// @[Decoupled.scala:51:35, :276:27, :277:33, :278:{25,28}, :302:19]
  ...
  ram_combMem_25_boom ram_ext (	// @[Decoupled.scala:273:95]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_last, io_enq_bits_echo_extra_id, io_enq_bits_echo_tl_state_source, io_enq_bits_echo_tl_state_size, io_enq_bits_resp, io_enq_bits_data, io_enq_bits_id}),	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_echo_tl_state_size = _ram_ext_R0_data[73:70];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_echo_tl_state_source = _ram_ext_R0_data[79:74];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_echo_extra_id = _ram_ext_R0_data[80];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_last = _ram_ext_R0_data[81];	// @[Decoupled.scala:273:95]
endmodule
