...
module TLAsyncCrossingSink_boom(
  input         clock,
                reset,
  ...
  AsyncQueueSink_3_boom x1_a_sink (	// @[AsyncQueue.scala:207:22]
    .clock                        (clock),
    .reset                        (reset),
  ...
  AsyncQueueSource_4_boom bundleIn_0_d_source (	// @[AsyncQueue.scala:216:24]
    .clock                        (clock),
    .reset                        (reset),
