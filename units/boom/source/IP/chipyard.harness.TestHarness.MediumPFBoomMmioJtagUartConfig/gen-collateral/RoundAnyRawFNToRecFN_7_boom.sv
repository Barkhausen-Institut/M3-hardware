...
module RoundAnyRawFNToRecFN_7_boom(
  input         io_invalidExc,
                io_infiniteExc,
                io_in_isNaN,
                io_in_isInf,
  ...
  wire [54:0] roundedSig = _overflow_roundMagUp_T & (|_GEN_0) | roundMagUp & anyRound ? {1'h0, io_in_sig[55:2] | _roundMask_T_129} + 55'h1 & ~(roundingMode_near_even & (|_GEN_0) & ~(|_GEN_1) ? {_roundMask_T_129, 1'h1} : 55'h0) : {1'h0, io_in_sig[55:2] & ~_roundMask_T_129} | (roundingMode_odd & anyRound ? _roundedSig_T_14 : 55'h0);	// @[RoundAnyRawFNToRecFN.scala:88:53, :93:53, :96:42, :160:57, :161:{28,46}, :162:{40,56}, :163:{42,62}, :164:36, :167:{38,67}, :168:31, :169:29, :171:16, :172:{32,49,61}, :173:{21,25,64}, :174:30, :178:{30,47}, :179:{24,42}, :218:62, :220:27, primitives.scala:61:24]
  ...
  assign io_out = {~isNaNOut & io_in_sign, sRoundedExp[11:0] & ~(io_in_isZero | common_totalUnderflow ? 12'hE00 : 12'h0) & ~(pegMinNonzeroMagOut ? 12'hC31 : 12'h0) & {1'h1, ~pegMaxFiniteMagOut, 10'h3FF} & {2'h3, ~notNaN_isInfOut, 9'h1FF} | (pegMinNonzeroMagOut ? 12'h3CE : 12'h0) | (pegMaxFiniteMagOut ? 12'hBFF : 12'h0) | (notNaN_isInfOut ? 12'hC00 : 12'h0) | (isNaNOut ? 12'hE00 : 12'h0), (isNaNOut | io_in_isZero | common_totalUnderflow ? {isNaNOut, 51'h0} : roundedSig[51:0]) | {52{pegMaxFiniteMagOut}}};	// @[Bitwise.scala:77:12, Cat.scala:33:92, RoundAnyRawFNToRecFN.scala:171:16, :183:40, :185:37, :189:27, :198:31, :220:27, :233:34, :243:45, :244:39, :246:32, :248:22, :251:{14,18,32}, :255:{14,18}, :256:19, :259:{14,18}, :262:17, :263:{14,18}, :267:16, :271:16, :275:{16,77}, :276:16, :278:{12,38}, :279:16, :281:11, primitives.scala:74:21]
  assign io_exceptionFlags = {io_invalidExc, io_infiniteExc, overflow, commonCase & (common_totalUnderflow | anyRound & io_in_sExp[12:11] != 2'h1 & _roundMask_T_129[0]), overflow | commonCase & (common_totalUnderflow | anyRound)};	// @[Cat.scala:33:92, RoundAnyRawFNToRecFN.scala:164:36, :198:31, :215:40, :218:{48,62,74}, :219:71, :228:49, :235:61, :236:32, :237:32, :238:{28,43}, primitives.scala:61:24]
endmodule
