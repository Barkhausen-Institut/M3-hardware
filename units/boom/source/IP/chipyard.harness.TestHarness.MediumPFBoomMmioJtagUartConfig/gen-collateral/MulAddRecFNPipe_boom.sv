...
module MulAddRecFNPipe_boom(
  ...
  MulAddRecFNToRaw_preMul_boom mulAddRecFNToRaw_preMul (	// @[FPU.scala:646:41]
    .io_op                        (io_op),
    .io_a                         (io_a),
    .io_b                         (io_b),
    .io_c                         (io_c),
  ...
  MulAddRecFNToRaw_postMul_boom mulAddRecFNToRaw_postMul (	// @[FPU.scala:647:42]
  ...
  RoundRawFNToRecFN_boom roundRawFNToRecFN (	// @[FPU.scala:674:35]
