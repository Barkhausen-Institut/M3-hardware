...
module TageTable_4_boom(
  ...
  wire [6:0]  _s2_req_rlous_T_1 = io_f1_req_pc[9:3] ^ io_f1_req_ghist[6:0] ^ io_f1_req_ghist[13:7] ^ io_f1_req_ghist[20:14] ^ io_f1_req_ghist[27:21] ^ {3'h0, io_f1_req_ghist[31:28]};	// @[frontend.scala:163:35, tage.scala:53:11, :55:25, :60:29, :67:20]
  ...
  wire [6:0]  update_idx = io_update_pc[9:3] ^ io_update_hist[6:0] ^ io_update_hist[13:7] ^ io_update_hist[20:14] ^ io_update_hist[27:21] ^ {3'h0, io_update_hist[31:28]};	// @[frontend.scala:163:35, tage.scala:53:11, :55:25, :60:29, :67:20]
  wire [8:0]  update_wdata_3_tag = io_update_pc[18:10] ^ io_update_hist[8:0] ^ io_update_hist[17:9] ^ io_update_hist[26:18] ^ {4'h0, io_update_hist[31:27]};	// @[frontend.scala:163:35, tage.scala:53:11, :55:25, :62:{30,50}]
  ...
  always @(posedge clock) begin
    ...
    s2_tag <= io_f1_req_pc[18:10] ^ io_f1_req_ghist[8:0] ^ io_f1_req_ghist[17:9] ^ io_f1_req_ghist[26:18] ^ {4'h0, io_f1_req_ghist[31:27]};	// @[frontend.scala:163:35, tage.scala:53:11, :55:25, :62:{30,50}, :95:29]
  ...
  hi_us_3_boom hi_us (	// @[tage.scala:89:27]
  ...
  lo_us_3_boom lo_us (	// @[tage.scala:90:27]
    .R0_addr (_s2_req_rlous_T_1),	// @[tage.scala:60:29]
    .R0_en   (io_f1_req_valid),
    .R0_clk  (clock),
  ...
  table_3_boom table_0 (	// @[tage.scala:91:27]
    .R0_addr (_s2_req_rlous_T_1),	// @[tage.scala:60:29]
    .R0_en   (io_f1_req_valid),
    .R0_clk  (clock),
