...
module Queue_83_boom(
  ...
  wire [7:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_combMem_3_boom ram_ext (	// @[Decoupled.scala:273:95]
    .R0_addr (1'h0),
    .R0_en   (1'h1),
    .R0_clk  (clock),
    .W0_addr (1'h0),
  ...
  assign io_deq_bits_tl_state_source = _ram_ext_R0_data[7:4];	// @[Decoupled.scala:273:95]
endmodule
