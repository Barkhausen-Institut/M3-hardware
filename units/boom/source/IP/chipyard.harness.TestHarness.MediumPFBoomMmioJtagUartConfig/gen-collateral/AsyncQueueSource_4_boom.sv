...
module AsyncQueueSource_4_boom(
  input         clock,
                reset,
                io_enq_valid,
  ...
  AsyncResetSynchronizerShiftReg_w1_d3_i0_boom ridx_ridx_gray (	// @[ShiftReg.scala:45:23]
    .clock (clock),
    .reset (reset),
    .io_d  (io_async_ridx),
    .io_q  (_ridx_ridx_gray_io_q)
  );
  AsyncValidSync_boom source_valid_0 (	// @[AsyncQueue.scala:100:32]
  ...
  AsyncValidSync_boom source_valid_1 (	// @[AsyncQueue.scala:101:32]
  ...
  AsyncValidSync_boom sink_extend (	// @[AsyncQueue.scala:103:30]
  ...
  AsyncValidSync_boom sink_valid (	// @[AsyncQueue.scala:104:30]
