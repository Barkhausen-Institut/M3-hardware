...
module PeripheryBus_1_boom(
  ...
  output [26:0] auto_coupler_to_bus_named_subsystem_pbus_bus_xing_out_a_bits_address,
  ...
  wire [27:0]     _atomics_auto_out_a_bits_address;	// @[AtomicAutomata.scala:285:29]
  ...
  wire [27:0]     _buffer_auto_out_a_bits_address;	// @[Buffer.scala:69:28]
  ...
  wire [27:0]     _in_xbar_auto_out_a_bits_address;	// @[PeripheryBus.scala:49:29]
  ...
  wire [27:0]     _fixer_auto_out_a_bits_address;	// @[PeripheryBus.scala:47:33]
  ...
  FixedClockBroadcast_3_boom fixedClockNode (	// @[ClockGroup.scala:110:107]
  ...
  TLFIFOFixer_3_boom fixer (	// @[PeripheryBus.scala:47:33]
  ...
  TLXbar_4_boom in_xbar (	// @[PeripheryBus.scala:49:29]
    .clock                    (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                    (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
    .auto_in_1_a_valid        (x1_2_a_valid),	// @[CustomBootPin.scala:44:20, :47:24]
    .auto_in_1_a_bits_address (_T_1 ? 28'h4000 : 28'h2000000),	// @[CustomBootPin.scala:47:24, :51:23, Edges.scala:478:15]
  ...
  TLXbar_5_boom out_xbar (	// @[PeripheryBus.scala:50:30]
    .clock                     (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                     (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
  ...
  TLBuffer_5_boom buffer (	// @[Buffer.scala:69:28]
    .clock                   (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                   (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
  ...
  TLAtomicAutomata_1_boom atomics (	// @[AtomicAutomata.scala:285:29]
    .clock                   (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                   (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
  ...
  ErrorDeviceWrapper_boom wrapped_error_device (	// @[LazyModule.scala:489:27]
    .clock                         (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                         (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
  ...
  TLInterconnectCoupler_9_boom coupler_to_l2_ctrl (	// @[LazyModule.scala:489:27]
    .clock                          (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                          (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
  ...
  TLInterconnectCoupler_11_boom coupler_to_plic (	// @[LazyModule.scala:489:27]
    .clock                              (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                              (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
  ...
  TLInterconnectCoupler_12_boom coupler_to_clint (	// @[LazyModule.scala:489:27]
    .clock                              (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                              (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
  ...
  TLInterconnectCoupler_14_boom coupler_to_debug (	// @[LazyModule.scala:489:27]
    .clock                              (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                              (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
  ...
  TLInterconnectCoupler_15_boom coupler_to_bootrom (	// @[LazyModule.scala:489:27]
    .clock                              (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                              (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
  ...
  TLInterconnectCoupler_17_boom coupler_to_prci_ctrl (	// @[LazyModule.scala:489:27]
    .clock                         (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                         (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
