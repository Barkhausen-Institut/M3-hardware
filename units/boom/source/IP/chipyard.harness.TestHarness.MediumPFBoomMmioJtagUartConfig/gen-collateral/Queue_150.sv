...
module Queue_150(
  ...
  wire [135:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_combMem_45 ram_ext (	// @[Decoupled.scala:273:95]
    ...
    .W0_clk  (clock),
    .W0_data ({1'h1, io_enq_bits_echo_real_last, io_enq_bits_resp, io_enq_bits_data, io_enq_bits_id}),	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_data = _ram_ext_R0_data[131:4];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_resp = _ram_ext_R0_data[133:132];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_echo_real_last = _ram_ext_R0_data[134];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_last = _ram_ext_R0_data[135];	// @[Decoupled.scala:273:95]
endmodule
