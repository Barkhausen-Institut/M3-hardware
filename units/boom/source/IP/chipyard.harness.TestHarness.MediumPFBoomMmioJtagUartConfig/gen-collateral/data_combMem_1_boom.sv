...
module data_combMem_1_boom(	// @[ListBuffer.scala:51:18]
  input  [5:0]  R0_addr,
  input         R0_en,
                R0_clk,
  input  [5:0]  W0_addr,
  ...
  reg [72:0] Memory[0:39];	// @[ListBuffer.scala:51:18]
  ...
  `ifndef SYNTHESIS	// @[ListBuffer.scala:51:18]
    `ifdef RANDOMIZE_MEM_INIT	// @[ListBuffer.scala:51:18]
      ...
      reg [95:0] _RANDOM_MEM;	// @[ListBuffer.scala:51:18]
    `endif // RANDOMIZE_MEM_INIT
  ...
  assign R0_data = R0_en ? Memory[R0_addr] : 73'bx;	// @[ListBuffer.scala:51:18]
endmodule
