...
module AXI4Buffer_boom(
  ...
  Queue_boom x1_aw_deq (	// @[Decoupled.scala:375:21]
    .clock             (clock),
    .reset             (reset),
  ...
  Queue_1_boom x1_w_deq (	// @[Decoupled.scala:375:21]
    .clock            (clock),
    .reset            (reset),
  ...
  Queue_2_boom bundleIn_0_b_deq (	// @[Decoupled.scala:375:21]
    .clock            (clock),
    .reset            (reset),
  ...
  Queue_boom x1_ar_deq (	// @[Decoupled.scala:375:21]
    .clock             (clock),
    .reset             (reset),
  ...
  Queue_4_boom bundleIn_0_r_deq (	// @[Decoupled.scala:375:21]
    .clock            (clock),
    .reset            (reset),
