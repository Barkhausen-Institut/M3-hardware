...
module ClockSinkDomain_3_boom(
  ...
  TLXbar_11_boom xbar (	// @[Xbar.scala:145:26]
  ...
  ClockGroupResetSynchronizer_boom resetSynchronizer (	// @[ResetSynchronizer.scala:44:69]
  ...
  TileClockGater_boom clock_gater (	// @[HasChipyardPRCI.scala:84:33]
    .clock                                               (auto_clock_in_clock),
  ...
  TileResetSetter_boom reset_setter (	// @[HasChipyardPRCI.scala:89:34]
