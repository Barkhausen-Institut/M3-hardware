...
module Queue_136(
  ...
  ram_combMem_2 ram_ext (	// @[Decoupled.scala:273:95]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_echo_real_last, io_enq_bits_resp, io_enq_bits_id}),	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_echo_real_last = _ram_ext_R0_data[6];	// @[Decoupled.scala:273:95]
endmodule
