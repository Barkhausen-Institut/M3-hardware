...
module TilePRCIDomain_boom(
  ...
  output        auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_valid,
  output [39:0] auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_iaddr,
  output [31:0] auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_insn,
  output [2:0]  auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_priv,
  output        auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_exception,
                auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_interrupt,
  output [63:0] auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_cause,
  output [39:0] auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_tval,
  output [63:0] auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_wdata,
  output        auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_valid,
  output [39:0] auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_iaddr,
  output [31:0] auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_insn,
  output [2:0]  auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_priv,
  output        auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_exception,
                auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_interrupt,
  output [63:0] auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_cause,
  output [39:0] auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_tval,
  output [63:0] auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_wdata,
                auto_tile_reset_domain_boom_tile_broadcast_out_time,
  output        auto_tile_reset_domain_boom_tile_broadcast_out_custom_rob_empty,
  ...
  wire [2:0]  _tile_reset_domain_boom_tile_auto_buffer_out_a_bits_source;	// @[HasTiles.scala:251:53]
  wire [31:0] _tile_reset_domain_boom_tile_auto_buffer_out_a_bits_address;	// @[HasTiles.scala:251:53]
  wire [7:0]  _tile_reset_domain_boom_tile_auto_buffer_out_a_bits_mask;	// @[HasTiles.scala:251:53]
  wire [63:0] _tile_reset_domain_boom_tile_auto_buffer_out_a_bits_data;	// @[HasTiles.scala:251:53]
  ...
  wire [2:0]  _tile_reset_domain_boom_tile_auto_buffer_out_c_bits_source;	// @[HasTiles.scala:251:53]
  wire [31:0] _tile_reset_domain_boom_tile_auto_buffer_out_c_bits_address;	// @[HasTiles.scala:251:53]
  wire [63:0] _tile_reset_domain_boom_tile_auto_buffer_out_c_bits_data;	// @[HasTiles.scala:251:53]
  ...
  wire [2:0]  _tile_reset_domain_boom_tile_auto_buffer_out_e_bits_sink;	// @[HasTiles.scala:251:53]
  BoomTile_boom tile_reset_domain_boom_tile (	// @[HasTiles.scala:251:53]
    ...
    .auto_broadcast_out_1_insns_0_valid     (auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_valid),
    .auto_broadcast_out_1_insns_0_iaddr     (auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_iaddr),
    .auto_broadcast_out_1_insns_0_insn      (auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_insn),
    .auto_broadcast_out_1_insns_0_priv      (auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_priv),
    .auto_broadcast_out_1_insns_0_exception (auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_exception),
    .auto_broadcast_out_1_insns_0_interrupt (auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_interrupt),
    .auto_broadcast_out_1_insns_0_cause     (auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_cause),
    .auto_broadcast_out_1_insns_0_tval      (auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_tval),
    .auto_broadcast_out_1_insns_0_wdata     (auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_wdata),
    .auto_broadcast_out_1_insns_1_valid     (auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_valid),
    .auto_broadcast_out_1_insns_1_iaddr     (auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_iaddr),
    .auto_broadcast_out_1_insns_1_insn      (auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_insn),
    .auto_broadcast_out_1_insns_1_priv      (auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_priv),
    .auto_broadcast_out_1_insns_1_exception (auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_exception),
    .auto_broadcast_out_1_insns_1_interrupt (auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_interrupt),
    .auto_broadcast_out_1_insns_1_cause     (auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_cause),
    .auto_broadcast_out_1_insns_1_tval      (auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_tval),
    .auto_broadcast_out_1_insns_1_wdata     (auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_wdata),
    .auto_broadcast_out_1_time              (auto_tile_reset_domain_boom_tile_broadcast_out_time),
    .auto_broadcast_out_1_custom_rob_empty  (auto_tile_reset_domain_boom_tile_broadcast_out_custom_rob_empty)
  );
  TLBuffer_16_boom buffer (	// @[Buffer.scala:69:28]
    .clock                   (auto_tap_clock_in_clock),
    .reset                   (auto_tap_clock_in_reset),
  ...
  IntSyncAsyncCrossingSink_1_boom intsink (	// @[Crossing.scala:78:29]
    .clock          (auto_tap_clock_in_clock),
    .auto_in_sync_0 (auto_intsink_in_sync_0),
    .auto_out_0     (_intsink_auto_out_0)
  );
  IntSyncSyncCrossingSink_boom intsink_1 (	// @[Crossing.scala:99:29]
  ...
  IntSyncCrossingSource_1_boom intsource_3 (	// @[Crossing.scala:28:31]
    .clock           (auto_tap_clock_in_clock),
    .reset           (auto_tap_clock_in_reset),
    .auto_in_0       (1'h0),
