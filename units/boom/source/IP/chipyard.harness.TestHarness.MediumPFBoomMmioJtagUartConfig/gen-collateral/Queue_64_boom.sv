...
module Queue_64_boom(
  ...
  wire [2:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_combMem_boom ram_ext (	// @[Decoupled.scala:273:95]
    .R0_addr (1'h0),
    .R0_en   (1'h1),
    .R0_clk  (clock),
    .W0_addr (1'h0),
  ...
  assign io_deq_bits_resp = maybe_full ? _ram_ext_R0_data[2:1] : io_enq_bits_resp;	// @[Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19]
endmodule
