...
module AsyncResetSynchronizerPrimitiveShiftReg_d3_i0_boom(
  input  clock,
         reset,
         io_d,
  output io_q
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        _RANDOM_0 = `RANDOM;
        sync_0 = _RANDOM_0[0];	// @[SynchronizerReg.scala:51:87]
        sync_1 = _RANDOM_0[1];	// @[SynchronizerReg.scala:51:87]
        sync_2 = _RANDOM_0[2];	// @[SynchronizerReg.scala:51:87]
      `endif // RANDOMIZE_REG_INIT
      `ifdef RANDOMIZE
        if (reset) begin
          sync_0 = 1'h0;	// @[SynchronizerReg.scala:51:87]
