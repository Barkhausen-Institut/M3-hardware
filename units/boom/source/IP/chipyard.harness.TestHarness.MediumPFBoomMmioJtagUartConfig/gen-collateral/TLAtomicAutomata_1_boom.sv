...
module TLAtomicAutomata_1_boom(
  input         clock,
                reset,
                auto_in_a_valid,
  ...
  reg  [27:0]     cam_a_0_bits_address;	// @[AtomicAutomata.scala:79:24]
  ...
  wire [6:0]      _GEN = {auto_in_a_bits_address[27:25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13] ^ 2'h1};	// @[AtomicAutomata.scala:199:23, Parameters.scala:137:{31,45}]
  wire [6:0]      _GEN_0 = {auto_in_a_bits_address[27:25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13] ^ 2'h2};	// @[AtomicAutomata.scala:83:44, Parameters.scala:137:{31,45}]
  wire [6:0]      _GEN_1 = {auto_in_a_bits_address[27:25] ^ 3'h2, auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13]};	// @[AtomicAutomata.scala:93:47, Parameters.scala:137:{31,45}]
  wire            a_isSupported = auto_in_a_bits_opcode == 3'h3 ? _a_canArithmetic_T_3 & (_GEN == 7'h0 | _GEN_0 == 7'h0 | _GEN_1 == 7'h0) : auto_in_a_bits_opcode != 3'h2 | _a_canArithmetic_T_3 & (_GEN == 7'h0 | _GEN_0 == 7'h0 | _GEN_1 == 7'h0);	// @[AtomicAutomata.scala:92:47, :93:47, :94:{32,63}, Bundles.scala:259:74, Mux.scala:81:61, Parameters.scala:92:42, :137:{45,65}, :671:54, :672:42]
  ...
  wire [6:0]      _GEN_2 = ~(cam_a_0_bits_mask[6:0]) | cam_a_0_bits_mask[7:1];	// @[AtomicAutomata.scala:79:24, :123:{25,31,39}]
  wire [6:0]      _GEN_3 = {cam_a_0_bits_data[55], cam_a_0_bits_data[47], cam_a_0_bits_data[39], cam_a_0_bits_data[31], cam_a_0_bits_data[23], cam_a_0_bits_data[15], cam_a_0_bits_data[7]} & ~_GEN_2;	// @[AtomicAutomata.scala:79:24, :115:63, :123:{23,31}, :127:38, Cat.scala:33:92]
  wire [6:0]      _GEN_4 = {cam_d_0_data[55], cam_d_0_data[47], cam_d_0_data[39], cam_d_0_data[31], cam_d_0_data[23], cam_d_0_data[15], cam_d_0_data[7]} & ~_GEN_2;	// @[AtomicAutomata.scala:80:24, :115:73, :123:{23,31}, :128:38, Cat.scala:33:92]
  wire [5:0]      _GEN_5 = _GEN_3[6:1] | _GEN_3[5:0];	// @[AtomicAutomata.scala:127:38, package.scala:245:{43,53}]
  wire [3:0]      _GEN_6 = _GEN_5[5:2] | _GEN_5[3:0];	// @[package.scala:245:{43,53}]
  wire            _signext_a_T_24 = _GEN_5[1] | _GEN_3[0];	// @[AtomicAutomata.scala:127:38, package.scala:245:43]
  wire [5:0]      _GEN_7 = _GEN_4[6:1] | _GEN_4[5:0];	// @[AtomicAutomata.scala:128:38, package.scala:245:{43,53}]
  wire [3:0]      _GEN_8 = _GEN_7[5:2] | _GEN_7[3:0];	// @[package.scala:245:{43,53}]
  wire            _signext_d_T_24 = _GEN_7[1] | _GEN_4[0];	// @[AtomicAutomata.scala:128:38, package.scala:245:43]
  ...
  wire [63:0]     a_a_ext = cam_a_0_bits_data & wide_mask | {{8{_GEN_6[3] | _signext_a_T_24}}, {8{_GEN_6[2] | _GEN_5[0]}}, {8{_GEN_6[1] | _GEN_3[0]}}, {8{_GEN_6[0]}}, {8{_signext_a_T_24}}, {8{_GEN_5[0]}}, {8{_GEN_3[0]}}, 8'h0};	// @[AtomicAutomata.scala:79:24, :127:38, :133:{28,41}, Bitwise.scala:77:12, Cat.scala:33:92, package.scala:245:43]
  wire [63:0]     a_d_ext = cam_d_0_data & wide_mask | {{8{_GEN_8[3] | _signext_d_T_24}}, {8{_GEN_8[2] | _GEN_7[0]}}, {8{_GEN_8[1] | _GEN_4[0]}}, {8{_GEN_8[0]}}, {8{_signext_d_T_24}}, {8{_GEN_7[0]}}, {8{_GEN_4[0]}}, 8'h0};	// @[AtomicAutomata.scala:80:24, :128:38, :134:{28,41}, Bitwise.scala:77:12, Cat.scala:33:92, package.scala:245:43]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        cam_a_0_bits_address = {_RANDOM_0[31:19], _RANDOM_1[14:0]};	// @[AtomicAutomata.scala:78:28, :79:24]
        cam_a_0_bits_mask = _RANDOM_1[22:15];	// @[AtomicAutomata.scala:79:24]
        cam_a_0_bits_data = {_RANDOM_1[31:23], _RANDOM_2, _RANDOM_3[22:0]};	// @[AtomicAutomata.scala:79:24]
        cam_a_0_bits_corrupt = _RANDOM_3[23];	// @[AtomicAutomata.scala:79:24]
        cam_a_0_fifoId = _RANDOM_3[24];	// @[AtomicAutomata.scala:79:24]
        cam_a_0_lut = _RANDOM_3[28:25];	// @[AtomicAutomata.scala:79:24]
        cam_d_0_data = {_RANDOM_3[31:29], _RANDOM_4, _RANDOM_5[28:0]};	// @[AtomicAutomata.scala:79:24, :80:24]
        cam_d_0_denied = _RANDOM_5[29];	// @[AtomicAutomata.scala:80:24]
        cam_d_0_corrupt = _RANDOM_5[30];	// @[AtomicAutomata.scala:80:24]
        beatsLeft = {_RANDOM_5[31], _RANDOM_6[7:0]};	// @[Arbiter.scala:88:30, AtomicAutomata.scala:80:24]
        state_0 = _RANDOM_6[8];	// @[Arbiter.scala:88:30, :117:26]
        state_1 = _RANDOM_6[9];	// @[Arbiter.scala:88:30, :117:26]
        d_first_counter = _RANDOM_6[18:10];	// @[Arbiter.scala:88:30, Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign auto_out_a_bits_address = (muxStateEarly_0 ? cam_a_0_bits_address : 28'h0) | (muxStateEarly_1 ? auto_in_a_bits_address : 28'h0);	// @[Arbiter.scala:118:30, AtomicAutomata.scala:79:24, Bundles.scala:259:74, Mux.scala:27:73]
