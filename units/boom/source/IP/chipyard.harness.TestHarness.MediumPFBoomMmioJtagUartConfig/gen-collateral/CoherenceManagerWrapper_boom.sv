...
module CoherenceManagerWrapper_boom(
  ...
  InclusiveCache_boom l2 (	// @[Configs.scala:76:24]
  ...
  TLBuffer_12_boom InclusiveCache_inner_TLBuffer (	// @[Parameters.scala:56:69]
    .clock                   (auto_subsystem_l2_clock_groups_in_member_subsystem_l2_0_clock),
    .reset                   (auto_subsystem_l2_clock_groups_in_member_subsystem_l2_0_reset),
  ...
  TLCacheCork_boom cork (	// @[Configs.scala:105:26]
    .clock                   (auto_subsystem_l2_clock_groups_in_member_subsystem_l2_0_clock),
    .reset                   (auto_subsystem_l2_clock_groups_in_member_subsystem_l2_0_reset),
  ...
  ProbePicker_boom binder (	// @[BankBinder.scala:68:28]
