...
module DigitalTop_boom(
  ...
  output [63:0]  traceIO_traces_0_trace_insns_0_wdata,
  output         traceIO_traces_0_trace_insns_1_valid,
  output [39:0]  traceIO_traces_0_trace_insns_1_iaddr,
  output [31:0]  traceIO_traces_0_trace_insns_1_insn,
  output [2:0]   traceIO_traces_0_trace_insns_1_priv,
  output         traceIO_traces_0_trace_insns_1_exception,
                 traceIO_traces_0_trace_insns_1_interrupt,
  output [63:0]  traceIO_traces_0_trace_insns_1_cause,
  output [39:0]  traceIO_traces_0_trace_insns_1_tval,
  output [63:0]  traceIO_traces_0_trace_insns_1_wdata,
                 traceIO_traces_0_trace_time,
  output         traceIO_traces_0_trace_custom_rob_empty,
                 uart_0_txd
);
  ...
  wire [2:0]  _tile_prci_domain_auto_tl_master_clock_xing_out_a_bits_source;	// @[HasTiles.scala:250:38]
  ...
  wire [2:0]  _tile_prci_domain_auto_tl_master_clock_xing_out_c_bits_source;	// @[HasTiles.scala:250:38]
  ...
  wire [2:0]  _subsystem_sbus_auto_coupler_from_boom_tile_tl_master_clock_xing_in_b_bits_source;	// @[SystemBus.scala:24:26]
  ...
  wire [2:0]  _subsystem_sbus_auto_coupler_from_boom_tile_tl_master_clock_xing_in_d_bits_source;	// @[SystemBus.scala:24:26]
  wire [2:0]  _subsystem_sbus_auto_coupler_from_boom_tile_tl_master_clock_xing_in_d_bits_sink;	// @[SystemBus.scala:24:26]
  wire        _subsystem_sbus_auto_coupler_from_boom_tile_tl_master_clock_xing_in_d_bits_denied;	// @[SystemBus.scala:24:26]
  wire [63:0] _subsystem_sbus_auto_coupler_from_boom_tile_tl_master_clock_xing_in_d_bits_data;	// @[SystemBus.scala:24:26]
  ...
  IntXbar_boom ibus_int_bus (	// @[InterruptBus.scala:14:27]
  ...
  IntSyncAsyncCrossingSink_boom ibus_intsink (	// @[Crossing.scala:78:29]
  ...
  SystemBus_boom subsystem_sbus (	// @[SystemBus.scala:24:26]
  ...
  PeripheryBus_boom subsystem_pbus (	// @[PeripheryBus.scala:31:26]
  ...
  FrontBus_boom subsystem_fbus (	// @[FrontBus.scala:22:26]
  ...
  PeripheryBus_1_boom subsystem_cbus (	// @[PeripheryBus.scala:31:26]
  ...
  MemoryBus_boom subsystem_mbus (	// @[MemoryBus.scala:25:26]
  ...
  CoherenceManagerWrapper_boom subsystem_l2_wrapper (	// @[BankedL2Params.scala:47:31]
  ...
  TilePRCIDomain_boom tile_prci_domain (	// @[HasTiles.scala:250:38]
    .auto_intsink_in_sync_0                                           (_tlDM_auto_dmOuter_intsource_out_sync_0),	// @[Periphery.scala:85:26]
    .auto_tile_reset_domain_boom_tile_hartid_in                       (_tileHartIdNexusNode_auto_out),	// @[HasTiles.scala:156:39]
    ...
    .auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_valid     (traceIO_traces_0_trace_insns_0_valid),
    .auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_iaddr     (traceIO_traces_0_trace_insns_0_iaddr),
    .auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_insn      (traceIO_traces_0_trace_insns_0_insn),
    .auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_priv      (traceIO_traces_0_trace_insns_0_priv),
    .auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_exception (traceIO_traces_0_trace_insns_0_exception),
    .auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_interrupt (traceIO_traces_0_trace_insns_0_interrupt),
    .auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_cause     (traceIO_traces_0_trace_insns_0_cause),
    .auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_tval      (traceIO_traces_0_trace_insns_0_tval),
    .auto_tile_reset_domain_boom_tile_broadcast_out_insns_0_wdata     (traceIO_traces_0_trace_insns_0_wdata),
    .auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_valid     (traceIO_traces_0_trace_insns_1_valid),
    .auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_iaddr     (traceIO_traces_0_trace_insns_1_iaddr),
    .auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_insn      (traceIO_traces_0_trace_insns_1_insn),
    .auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_priv      (traceIO_traces_0_trace_insns_1_priv),
    .auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_exception (traceIO_traces_0_trace_insns_1_exception),
    .auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_interrupt (traceIO_traces_0_trace_insns_1_interrupt),
    .auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_cause     (traceIO_traces_0_trace_insns_1_cause),
    .auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_tval      (traceIO_traces_0_trace_insns_1_tval),
    .auto_tile_reset_domain_boom_tile_broadcast_out_insns_1_wdata     (traceIO_traces_0_trace_insns_1_wdata),
    .auto_tile_reset_domain_boom_tile_broadcast_out_time              (traceIO_traces_0_trace_time),
    .auto_tile_reset_domain_boom_tile_broadcast_out_custom_rob_empty  (traceIO_traces_0_trace_custom_rob_empty),
  ...
  ClockSinkDomain_boom plicDomainWrapper (	// @[Plic.scala:359:39]
  ...
  CLINT_boom clint (	// @[CLINT.scala:107:27]
  ...
  BundleBridgeNexus_15_boom tileHartIdNexusNode (	// @[HasTiles.scala:156:39]
    .auto_out (_tileHartIdNexusNode_auto_out)
  );
  TLDebugModule_boom tlDM (	// @[Periphery.scala:85:26]
  ...
  IntSyncCrossingSource_5_boom intsource (	// @[Crossing.scala:28:31]
    .clock           (clock),
    .reset           (reset),
  ...
  IntSyncSyncCrossingSink_1_boom intsink_2 (	// @[Crossing.scala:99:29]
  ...
  IntSyncSyncCrossingSink_1_boom intsink_3 (	// @[Crossing.scala:99:29]
  ...
  IntSyncCrossingSource_8_boom intsource_3 (	// @[Crossing.scala:28:31]
    .clock           (clock),
    .reset           (reset),
  ...
  ClockSinkDomain_1_boom bootROMDomainWrapper (	// @[BootROM.scala:72:42]
  ...
  ClockSinkDomain_2_boom uartClockDomainWrapper (	// @[UART.scala:270:44]
  ...
  IntSyncSyncCrossingSink_1_boom intsink_4 (	// @[Crossing.scala:99:29]
    .auto_in_sync_0 (_uartClockDomainWrapper_auto_uart_0_int_xing_out_sync_0),	// @[UART.scala:270:44]
    .auto_out_0     (_intsink_4_auto_out_0)
  );
  ClockSinkDomain_3_boom prci_ctrl_domain (	// @[HasChipyardPRCI.scala:36:36]
  ...
  ClockGroupAggregator_6_boom aggregator (	// @[HasChipyardPRCI.scala:48:30]
  ...
  ClockGroupParameterModifier_boom clockNamePrefixer (	// @[ClockGroupNamePrefixer.scala:45:15]
  ...
  ClockGroupParameterModifier_1_boom frequencySpecifier (	// @[ClockGroupNamePrefixer.scala:81:15]
  ...
  ClockGroupCombiner_boom clockGroupCombiner (	// @[ClockGroupCombiner.scala:19:15]
  ...
  DebugTransportModuleJTAG_boom dtm (	// @[Periphery.scala:163:21]
