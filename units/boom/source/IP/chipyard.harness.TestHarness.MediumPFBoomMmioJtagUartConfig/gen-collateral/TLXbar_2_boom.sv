...
module TLXbar_2_boom(
  ...
  output [26:0] auto_out_1_a_bits_address,
  ...
  assign auto_in_a_ready = ~(auto_in_a_bits_address[26]) & auto_out_0_a_ready | auto_in_a_bits_address[26] & auto_out_1_a_ready;	// @[Mux.scala:27:73, Parameters.scala:137:{45,65}]
  ...
  assign auto_in_d_bits_size = (muxStateEarly_0 ? auto_out_0_d_bits_size : 3'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_size : 3'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  ...
  assign auto_out_1_a_valid = auto_in_a_valid & auto_in_a_bits_address[26];	// @[Parameters.scala:137:45, Xbar.scala:431:50]
  ...
  assign auto_out_0_a_valid = auto_in_a_valid & ~(auto_in_a_bits_address[26]);	// @[Parameters.scala:137:{45,65}, Xbar.scala:431:50]
