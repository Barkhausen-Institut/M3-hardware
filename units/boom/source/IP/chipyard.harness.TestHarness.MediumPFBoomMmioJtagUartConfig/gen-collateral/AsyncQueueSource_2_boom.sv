...
module AsyncQueueSource_2_boom(
  input         clock,
                reset,
                io_enq_valid,
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mem_0_size = _RANDOM_0[7:6];	// @[AsyncQueue.scala:80:16]
        mem_0_source = _RANDOM_0[8];	// @[AsyncQueue.scala:80:16]
        mem_0_address = _RANDOM_0[17:9];	// @[AsyncQueue.scala:80:16]
        mem_0_mask = _RANDOM_0[21:18];	// @[AsyncQueue.scala:80:16]
        mem_0_data = {_RANDOM_0[31:22], _RANDOM_1[21:0]};	// @[AsyncQueue.scala:80:16]
        mem_0_corrupt = _RANDOM_1[22];	// @[AsyncQueue.scala:80:16]
        widx_widx_bin = _RANDOM_1[23];	// @[AsyncQueue.scala:52:25, :80:16]
        ready_reg = _RANDOM_1[24];	// @[AsyncQueue.scala:80:16, :88:56]
        widx_gray = _RANDOM_1[25];	// @[AsyncQueue.scala:80:16, :91:55]
      `endif // RANDOMIZE_REG_INIT
      `ifdef RANDOMIZE
        if (reset) begin
          widx_widx_bin = 1'h0;	// @[AsyncQueue.scala:52:25]
