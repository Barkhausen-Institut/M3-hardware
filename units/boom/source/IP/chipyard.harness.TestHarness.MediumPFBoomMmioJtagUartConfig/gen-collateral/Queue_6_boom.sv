...
module Queue_6_boom(
  ...
  wire [10:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_combMem_8_boom ram_ext (	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_tl_state_source = _ram_ext_R0_data[9:4];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_extra_id = _ram_ext_R0_data[10];	// @[Decoupled.scala:273:95]
endmodule
