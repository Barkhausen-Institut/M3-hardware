...
module RoundAnyRawFNToRecFN_3_boom(
  input         io_invalidExc,
                io_in_isNaN,
                io_in_isInf,
                io_in_isZero,
