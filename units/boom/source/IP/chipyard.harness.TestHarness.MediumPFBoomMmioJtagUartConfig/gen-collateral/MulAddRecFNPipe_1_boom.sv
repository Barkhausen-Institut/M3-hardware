...
module MulAddRecFNPipe_1_boom(
  ...
  MulAddRecFNToRaw_preMul_1_boom mulAddRecFNToRaw_preMul (	// @[FPU.scala:646:41]
    .io_op                        (io_op),
    .io_a                         (io_a),
    .io_b                         (io_b),
    .io_c                         (io_c),
  ...
  MulAddRecFNToRaw_postMul_1_boom mulAddRecFNToRaw_postMul (	// @[FPU.scala:647:42]
  ...
  RoundRawFNToRecFN_1_boom roundRawFNToRecFN (	// @[FPU.scala:674:35]
