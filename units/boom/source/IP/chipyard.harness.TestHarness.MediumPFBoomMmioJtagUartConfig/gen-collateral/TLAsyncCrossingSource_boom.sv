...
module TLAsyncCrossingSource_boom(
  input         clock,
                reset,
                auto_in_a_valid,
  ...
  AsyncQueueSource_2_boom x1_a_source (	// @[AsyncQueue.scala:216:24]
    .clock                        (clock),
    .reset                        (reset),
  ...
  AsyncQueueSink_2_boom bundleIn_0_d_sink (	// @[AsyncQueue.scala:207:22]
    .clock                        (clock),
    .reset                        (reset),
