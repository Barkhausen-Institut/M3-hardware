...
module FPToFP_boom(
  ...
  reg  [64:0] io_out_outPipe_bits_data;	// @[Reg.scala:19:16]
  reg  [4:0]  io_out_outPipe_bits_exc;	// @[Reg.scala:19:16]
  reg         io_out_outPipe_valid_1;	// @[Valid.scala:130:22]
  reg  [64:0] io_out_outPipe_bits_1_data;	// @[Reg.scala:19:16]
  reg  [4:0]  io_out_outPipe_bits_1_exc;	// @[Reg.scala:19:16]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      io_out_v <= 1'h0;	// @[Valid.scala:130:22]
      io_out_outPipe_valid <= 1'h0;	// @[Valid.scala:130:22]
      io_out_outPipe_valid_1 <= 1'h0;	// @[Valid.scala:130:22]
    end
    else begin
      inPipe_valid <= io_in_valid;	// @[Valid.scala:130:22]
      io_out_v <= inPipe_valid;	// @[Valid.scala:130:22]
    ...
    if (io_out_v) begin	// @[Valid.scala:130:22]
      ...
      io_out_outPipe_bits_exc <= io_out_b_exc;	// @[Reg.scala:19:16]
    end
    if (io_out_outPipe_valid) begin	// @[Valid.scala:130:22]
      io_out_outPipe_bits_1_data <= io_out_outPipe_bits_data;	// @[Reg.scala:19:16]
      io_out_outPipe_bits_1_exc <= io_out_outPipe_bits_exc;	// @[Reg.scala:19:16]
    end
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_out_v = _RANDOM_6[31];	// @[Valid.scala:130:22]
        io_out_b_data = {_RANDOM_7, _RANDOM_8, _RANDOM_9[0]};	// @[Reg.scala:19:16]
        io_out_b_exc = _RANDOM_9[5:1];	// @[Reg.scala:19:16]
        io_out_outPipe_valid = _RANDOM_9[6];	// @[Reg.scala:19:16, Valid.scala:130:22]
        io_out_outPipe_bits_data = {_RANDOM_9[31:7], _RANDOM_10, _RANDOM_11[7:0]};	// @[Reg.scala:19:16]
        io_out_outPipe_bits_exc = _RANDOM_11[12:8];	// @[Reg.scala:19:16]
        io_out_outPipe_valid_1 = _RANDOM_11[13];	// @[Reg.scala:19:16, Valid.scala:130:22]
        io_out_outPipe_bits_1_data = {_RANDOM_11[31:14], _RANDOM_12, _RANDOM_13[14:0]};	// @[Reg.scala:19:16]
        io_out_outPipe_bits_1_exc = _RANDOM_13[19:15];	// @[Reg.scala:19:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  RecFNToRecFN_boom narrower (	// @[FPU.scala:612:30]
  ...
  assign io_out_valid = io_out_outPipe_valid_1;	// @[Valid.scala:130:22]
  assign io_out_bits_data = io_out_outPipe_bits_1_data;	// @[Reg.scala:19:16]
  assign io_out_bits_exc = io_out_outPipe_bits_1_exc;	// @[Reg.scala:19:16]
endmodule
