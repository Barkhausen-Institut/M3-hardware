...
module ListBuffer_boom(
  ...
  head_combMem_1_boom head_ext (	// @[ListBuffer.scala:47:18]
    .R0_addr (io_pop_bits),
    .R0_en   (1'h1),
    .R0_clk  (clock),
  ...
  tail_combMem_1_boom tail_ext (	// @[ListBuffer.scala:48:18]
    .R0_addr (io_pop_bits),
    .R0_en   (io_pop_valid),
    .R0_clk  (clock),
  ...
  next_combMem_1_boom next_ext (	// @[ListBuffer.scala:50:18]
  ...
  data_combMem_1_boom data_ext (	// @[ListBuffer.scala:51:18]
    .R0_addr (_head_ext_R0_data),	// @[ListBuffer.scala:47:18]
    .R0_en   (1'h1),
    .R0_clk  (clock),
