...
module Queue_116_boom(
  ...
  ram_combMem_41_boom ram_ext (	// @[Decoupled.scala:273:95]
    .R0_addr (1'h0),
    .R0_en   (1'h1),
    .R0_clk  (clock),
    .W0_addr (1'h0),
  ...
  assign io_deq_bits_mask = maybe_full ? _ram_ext_R0_data[54:47] : io_enq_bits_mask;	// @[Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19]
  assign io_deq_bits_data = maybe_full ? _ram_ext_R0_data[118:55] : io_enq_bits_data;	// @[Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19]
  assign io_deq_bits_corrupt = maybe_full ? _ram_ext_R0_data[119] : io_enq_bits_corrupt;	// @[Decoupled.scala:273:95, :276:27, :310:17, :315:17, :316:19]
endmodule
