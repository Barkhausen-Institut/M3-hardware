...
module Repeater_9_boom(
  ...
  always @(posedge clock) begin
    ...
    if (_T_1) begin	// @[Repeater.scala:28:23]
      ...
      saved_param <= 2'h0;	// @[Repeater.scala:20:18]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_size = _RANDOM_0[8:6];	// @[Repeater.scala:19:21, :20:18]
        saved_source = _RANDOM_0[12:9];	// @[Repeater.scala:19:21, :20:18]
        saved_denied = _RANDOM_0[14];	// @[Repeater.scala:19:21, :20:18]
        saved_data = {_RANDOM_0[31:15], _RANDOM_1, _RANDOM_2, _RANDOM_3, _RANDOM_4[14:0]};	// @[Repeater.scala:19:21, :20:18]
        saved_corrupt = _RANDOM_4[15];	// @[Repeater.scala:20:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_deq_bits_param = full ? saved_param : 2'h0;	// @[Repeater.scala:19:21, :20:18, :25:21]
