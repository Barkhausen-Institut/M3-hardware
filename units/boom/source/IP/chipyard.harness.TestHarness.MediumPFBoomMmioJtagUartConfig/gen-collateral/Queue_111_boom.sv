...
module Queue_111_boom(
  ...
  wire [111:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_combMem_35_boom ram_ext (	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_data = _ram_ext_R0_data[110:47];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[111];	// @[Decoupled.scala:273:95]
endmodule
