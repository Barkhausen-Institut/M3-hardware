...
module BasicDispatcher_boom(
  ...
  wire [1:0] ren_readys = {io_dis_uops_0_1_ready, io_dis_uops_0_0_ready} & {io_dis_uops_1_1_ready, io_dis_uops_1_0_ready} & {io_dis_uops_2_1_ready, io_dis_uops_2_0_ready};	// @[dispatch.scala:47:{63,79}]
