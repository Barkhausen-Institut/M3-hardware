...
module Queue_59_boom(
  ...
  wire [126:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  ram_combMem_43_boom ram_ext (	// @[Decoupled.scala:273:95]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_corrupt, io_enq_bits_data, io_enq_bits_mask, io_enq_bits_user_amba_prot_fetch, io_enq_bits_user_amba_prot_secure, io_enq_bits_user_amba_prot_privileged, io_enq_bits_user_amba_prot_writealloc, io_enq_bits_user_amba_prot_readalloc, io_enq_bits_user_amba_prot_modifiable, io_enq_bits_user_amba_prot_bufferable, io_enq_bits_address, io_enq_bits_source, io_enq_bits_size, io_enq_bits_param, io_enq_bits_opcode}),	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_user_amba_prot_bufferable = _ram_ext_R0_data[47];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_user_amba_prot_modifiable = _ram_ext_R0_data[48];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_user_amba_prot_readalloc = _ram_ext_R0_data[49];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_user_amba_prot_writealloc = _ram_ext_R0_data[50];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_user_amba_prot_privileged = _ram_ext_R0_data[51];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_user_amba_prot_secure = _ram_ext_R0_data[52];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_user_amba_prot_fetch = _ram_ext_R0_data[53];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[61:54];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[125:62];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[126];	// @[Decoupled.scala:273:95]
endmodule
